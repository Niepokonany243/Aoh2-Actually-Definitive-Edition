...
public class Event_Outcome_GoldenAgeProsp
extends Event_Outcome {
    ...
    public void outcomeAction() {
        try {
            if (this.canMakeAction()) {
                GameManager.goldenAge_Prosperity(this.getCivID());
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAProsperity") + ": " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAProsperity");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("GoldenAge") + ": "));
                tData.add(new ME_Hover_2Type_Text("" + CFG.lang.get("GAProsperity"), CFG.COLOR_HOVER_TITLE));
                tData.add(new ME_Hover_2Type_Image(Images.diploGoldenAge, CFG.PADD, 0));
