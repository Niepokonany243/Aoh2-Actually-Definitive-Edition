...
public class Event_Conditions_NonAggression
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCivNonAggressionPact(this.getCivID(), this.getCivID2()) > 0;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("NonAggressionPact") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + " - " + CFG.core.getCiv(this.getCivID2()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
