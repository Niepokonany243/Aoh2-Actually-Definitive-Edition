...
public class Event_Outcome_GlobalEconomyPerc
extends Event_Outcome {
    ...
    public void outcomeAction() {
        try {
            for (int i = 0; i < CFG.core.getProvinSize(); ++i) {
                ...
                CFG.core.getProv(i).setEco((int)((float)CFG.core.getProv(i).getEco() * (1.0f + (float)this.iValue / 1000.0f)));
            }
        }
        catch (Exception ex) {
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("UpdateEconomyPercentage") + ": " + CFG.getPrecision2((float)this.getValue() / 10.0f, 100) + "%";
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("UpdateEconomyPercentage");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            tData.add(new ME_Hover_2Type_Text(CFG.lang.get("Economy") + ": "));
    ...
    public final void editViewID() {
        CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_OUT_GLOBAL_ECONOMY_PERC);
    }
}
