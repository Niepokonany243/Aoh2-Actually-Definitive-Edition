...
extends ButtonM {
    ...
    public ButtonN_Wonder(Color nColor, int nProvinceID, int nWonderID, int iPosX, int iPosY, int iWidth) {
        ...
        this.wonderBuilt = CFG.core.getProv((int)nProvinceID).provGD.wonderBuilt;
        this.sDeathsTEXT = CFG.core.getProv(nProvinceID).getName().length() > 0 ? CFG.core.getProv(nProvinceID).getName() : CFG.core.getCiv(CFG.core.getProv(nProvinceID).getCivId()).getCivName();
    }
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).sName), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_WonderBig(this.iProvinceID, this.iWonderID, CFG.PADD, 0));
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ConstructAWonder")));
        nData.add(new ME_Hover_2Type_Image(Images.iconTrue, CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        try {
            CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.drawO(oSB, this.getPosXE() + ButtonDiplomacy.iDiploWidth / 2 - (int)((float)(CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.getWidth() / 2) * CFG.GUI_SCALE) + iTranslateX, this.getPosY() + this.getHeightE() / 2 - (int)((float)CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.getHeight() * CFG.GUI_SCALE / 2.0f) - CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.getHeight() + iTranslateY, (int)((float)CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.getWidth() * CFG.GUI_SCALE), (int)((float)CFG.core.getProv((int)this.iProvinceID).getWonder((int)this.iWonderID).nImage.getHeight() * CFG.GUI_SCALE));
            Core.drawFlagRect(oSB, this.getPosXE() + this.getWidthE() - IMGManager.getIMG(Images.flagRect2).getWidth() - CFG.PADD + iTranslateX, this.getPosY() + this.getHeightE() / 2 - IMGManager.getIMG(Images.flagRect2).getHeight() / 2 + iTranslateY, CFG.core.getProv(this.iProvinceID).getCivId());
            oSB.setColor(Color.WHITE);
