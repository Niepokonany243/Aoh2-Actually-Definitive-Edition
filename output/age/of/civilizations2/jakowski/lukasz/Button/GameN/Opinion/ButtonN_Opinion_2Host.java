...
public class ButtonN_Opinion_2Host
extends ButtonM {
    ...
    public ButtonN_Opinion_2Host(int iCivA, int iCivB, int nImageID, int nCost, int nDiploCost, int iPosX, int iPosY, int iWidth) {
        ...
        if (this.checkbox) {
            return new ButtonM.Checkbox(){
                ...
                public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
                    if (ButtonN_Opinion_2Host.this.getCheckboxSt()) {
                        oSB.setColor(new Color(CFG.COLOR_POSITIVE.r, CFG.COLOR_POSITIVE.g, CFG.COLOR_POSITIVE.b, 0.2f));
                        IMGManager.getIMG(Images.patternSquareTiny).draw2O(oSB, ButtonN_Opinion_2Host.this.getPosXE() + iTranslateX, ButtonN_Opinion_2Host.this.getPosY() - IMGManager.getIMG(Images.patternSquareTiny).getHeight() + 1 + iTranslateY, ButtonDiplomacy.iDiploWidth, ButtonN_Opinion_2Host.this.getHeightE() - 2, true, false);
                        oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.3f));
                        IMGManager.getIMG(Images.gradient).drawO(oSB, ButtonN_Opinion_2Host.this.getPosXE() + iTranslateX, ButtonN_Opinion_2Host.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + 1 + iTranslateY, ButtonDiplomacy.iDiploWidth, ButtonN_Opinion_2Host.this.getHeightE() / 4, false, false);
                        IMGManager.getIMG(Images.gradient).drawO(oSB, ButtonN_Opinion_2Host.this.getPosXE() + iTranslateX, ButtonN_Opinion_2Host.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + ButtonN_Opinion_2Host.this.getHeightE() - 1 + iTranslateY - ButtonN_Opinion_2Host.this.getHeightE() / 4, ButtonDiplomacy.iDiploWidth, ButtonN_Opinion_2Host.this.getHeightE() / 4, false, true);
