...
public class Button_DiplomacyAction
extends ButtonM {
    public int iImageID = 0;
    public boolean row = false;
    public SparksAnimation sparksAnimation;

    public Button_DiplomacyAction(int nImageID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
    ...
    public Button_DiplomacyAction(int nImageID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable, boolean checkbox) {
        this.fontID = CFG.FONT_BOLD_SMALL;
        super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable, true, true, checkbox);
        this.sparksAnimation = new SparksAnimation();
        this.iImageID = nImageID;
    }
