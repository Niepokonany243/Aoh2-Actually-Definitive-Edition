...
public class Button_DiplomacyAction_TextRight
extends ButtonM {
    ...
    public Button_DiplomacyAction_TextRight(int nImageID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable, String numberRight, int nImage2) {
