...
public class Button_Diplomacy_Civilize2
extends ButtonM {
    ...
    public Button_Diplomacy_Civilize2(int iCivID, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean nCheckbox) {
        this.fontID = CFG.FONT_BOLD_SMALL;
        super.init(CFG.lang.get("ChangeTypeOfGovernmentTo") + ": ", 0, iPosX, iPosY, iWidth, Math.max(Math.max(CFG.TEXT_HEIGHT_DEFAULT, CFG.CIV_FLAG_HEIGHT) + CFG.PADD * 4, CFG.BUTTON_H), isClickable, true, true, nCheckbox);
        this.iCivID = iCivID;
        ...
        if (this.checkbox) {
            return new ButtonM.Checkbox(){
                ...
                public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
                    if (Button_Diplomacy_Civilize2.this.getCheckboxSt()) {
                        oSB.setColor(new Color(0.55f, 0.8f, 0.0f, 0.3f));
                    } else {
                        oSB.setColor(new Color(0.8f, 0.137f, 0.0f, 0.3f));
                    }
                    IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Button_Diplomacy_Civilize2.this.getPosXE() + iTranslateX, Button_Diplomacy_Civilize2.this.getPosY() - IMGManager.getIMG(Images.sliderGradient).getHeight() + 1 + iTranslateY, Button_Diplomacy_Civilize2.this.getWidthE() / 6, Button_Diplomacy_Civilize2.this.getHeightE() - 2, false, false);
                    oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.2f));
                    IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Button_Diplomacy_Civilize2.this.getPosXE() + iTranslateX, Button_Diplomacy_Civilize2.this.getPosY() - IMGManager.getIMG(Images.sliderGradient).getHeight() + 1 + iTranslateY, Button_Diplomacy_Civilize2.this.getWidthE() / 10, Button_Diplomacy_Civilize2.this.getHeightE() - 2, false, false);
                    oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.5f));
                    IMGManager.getIMG(Images.gradient).drawO(oSB, Button_Diplomacy_Civilize2.this.getPosXE() + iTranslateX, Button_Diplomacy_Civilize2.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + 1 + iTranslateY, Button_Diplomacy_Civilize2.this.getWidthE(), CFG.PADD, false, false);
                    IMGManager.getIMG(Images.gradient).drawO(oSB, Button_Diplomacy_Civilize2.this.getPosXE() + iTranslateX, Button_Diplomacy_Civilize2.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + Button_Diplomacy_Civilize2.this.getHeightE() - 1 + iTranslateY - CFG.PADD, Button_Diplomacy_Civilize2.this.getWidthE(), CFG.PADD, false, true);
                    oSB.setColor(Color.WHITE);
                }
            };
        }
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        Rectangle clipBounds = new Rectangle(this.getPosXE() + ButtonDiplomacy.iDiploWidth + iTranslateX, CFG.GAMEHEIGHT - this.getPosY() - iTranslateY - this.getHeightE(), this.getWidthE() - this.getRightWidth() - ButtonDiplomacy.iDiploWidth, this.getHeightE());
        oSB.flush();
    ...
    public void buildElemHover() {
        try {
            ...
            nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ChangeTypeOfGovernmentTo") + "..?", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
