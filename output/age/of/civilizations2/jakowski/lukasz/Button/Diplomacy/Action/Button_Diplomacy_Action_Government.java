...
public class Button_Diplomacy_Action_Government
extends ButtonM {
    private int iGovID = 0;
    private boolean row = false;
    public SparksAnimation sparksAnimation;

    public Button_Diplomacy_Action_Government(int nGovID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        CFG.ideologiesMgr.getIdeologyID(this.iGovID).getCrownImageScaled().drawO(oSB, this.getPosXE() + (ButtonDiplomacy.iDiploWidth - CFG.ideologiesMgr.getIdeologyID(this.iGovID).getCrownImageScaled().getWidth()) / 2 + iTranslateX, this.getPosY() + this.getHeightE() / 2 - CFG.ideologiesMgr.getIdeologyID(this.iGovID).getCrownImageScaled().getHeight() / 2 + iTranslateY);
