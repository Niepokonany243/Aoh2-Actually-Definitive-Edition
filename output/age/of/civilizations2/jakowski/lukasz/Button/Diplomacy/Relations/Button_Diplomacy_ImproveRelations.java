...
public class Button_Diplomacy_ImproveRelations
extends ButtonStats {
    ...
    public Button_Diplomacy_ImproveRelations(String sText, float iRelationDiff, int nAggressor, int nDefender, int iPosX, int iPosY, int iWidth) {
        ...
        this.sDiploCost = "" + (float)GameValues.gvRelationImprove.COST_OFFER_IMPROVE_RELATIONS_DIPLOMACY_POINTS / 10.0f;
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        oSB.setColor(Color.WHITE);
        CFG.core.getCiv(this.iCivB).getFlagC().drawO(oSB, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 2 + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (CFG.TEXT_HEIGHT_DEFAULT - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall))) / 2 - CFG.core.getCiv(this.iCivB).getFlagC().getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        IMGManager.getIMG(Images.flagRectSmall).drawO(oSB, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 2 + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (CFG.TEXT_HEIGHT_DEFAULT - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall))) / 2 - IMGManager.getIMG(Images.flagRectSmall).getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        ...
        CFG.drawTextDefaultWithShadow(oSB, this.sCurrentRelation, this.getPosXE() + CFG.PADD * 2 + (int)((float)this.getTextWidthU() * 0.7f) + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, CFG.core.getCivRelationOfCivB(this.iCivB, this.iCivA) > 0.0f ? CFG.COLOR_POSITIVE : (CFG.core.getCivRelationOfCivB(this.iCivB, this.iCivA) == 0.0f ? CFG.COLOR_NEUTRAL : CFG.COLOR_NEGATIVE_2));
        CFG.drawTextDefaultWithShadow(oSB, this.sCivBName, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 3 + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, this.getColorE(isActive));
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("ImproveRelation"), CFG.COLOR_HOVER_TITLE));
        nData.add(new ME_Hover_2Type_Flag_Big(this.iCivA, CFG.PADD, CFG.PADD));
