...
public class Buton_Diplomacy_LoanGlobal
extends ButtonStats {
    public int loanID;
    public int iCivA;
    ...
    public Buton_Diplomacy_LoanGlobal(int i, int iCivA, int iMoneyPerTurn, int iMoney, int iTurnsLeft, int iPosX, int iPosY, int iWidth) {
        ...
        this.sCivName = CFG.core.getCiv(iCivA).getCivName() + ": ";
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        Renderer.drawTextWithShadow(oSB, this.fontID, this.getTextE(), this.getPosXE() + IMGManager.getIMG(Images.flagRect2).getWidth() + CFG.PADD * 5 + this.iCivNameWidth + IMGManager.getIMG(Images.diploLoan).getWidth() + 2 + iTranslateX, this.getPosY() + this.getHeightE() / 2 - (int)((float)this.getTextHeight() / 2.0f) + iTranslateY, isActive ? CFG.COLOR_GOLD_ACTIVE : (this.getIsHovered() ? CFG.COLOR_GOLD_HOVER : CFG.COLOR_GOLD));
        Renderer.drawTextWithShadow(oSB, this.fontID, this.sCivName, this.getPosXE() + IMGManager.getIMG(Images.flagRect2).getWidth() + CFG.PADD * 4 + IMGManager.getIMG(Images.diploLoan).getWidth() + 2 + iTranslateX, this.getPosY() + this.getHeightE() / 2 - (int)((float)this.getTextHeight() / 2.0f) + iTranslateY, this.getColorE(isActive));
        ...
        if (this.checkbox) {
            return new ButtonM.Checkbox(){
                ...
                public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
                    if (Buton_Diplomacy_LoanGlobal.this.getCheckboxSt()) {
                        oSB.setColor(new Color(0.55f, 0.8f, 0.0f, 0.2f));
                    } else {
                        oSB.setColor(new Color(0.8f, 0.137f, 0.0f, 0.15f));
                    }
                    IMGManager.getIMG(Images.line32Off1).drawO(oSB, Buton_Diplomacy_LoanGlobal.this.getPosXE() + iTranslateX, Buton_Diplomacy_LoanGlobal.this.getPosY() - IMGManager.getIMG(Images.line32Off1).getHeight() + 1 + iTranslateY, Buton_Diplomacy_LoanGlobal.this.getWidthE(), Buton_Diplomacy_LoanGlobal.this.getHeightE() - 2, true, false);
                    oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.3f));
                    IMGManager.getIMG(Images.gradient).drawO(oSB, Buton_Diplomacy_LoanGlobal.this.getPosXE() + iTranslateX, Buton_Diplomacy_LoanGlobal.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + 1 + iTranslateY, Buton_Diplomacy_LoanGlobal.this.getWidthE(), Buton_Diplomacy_LoanGlobal.this.getHeightE() / 4, false, false);
                    IMGManager.getIMG(Images.gradient).drawO(oSB, Buton_Diplomacy_LoanGlobal.this.getPosXE() + iTranslateX, Buton_Diplomacy_LoanGlobal.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + Buton_Diplomacy_LoanGlobal.this.getHeightE() - 1 + iTranslateY - Buton_Diplomacy_LoanGlobal.this.getHeightE() / 4, Buton_Diplomacy_LoanGlobal.this.getWidthE(), Buton_Diplomacy_LoanGlobal.this.getHeightE() / 4, false, true);
                    oSB.setColor(Color.WHITE);
                }
            };
        }
