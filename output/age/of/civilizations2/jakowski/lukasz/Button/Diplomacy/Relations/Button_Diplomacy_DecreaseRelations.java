...
public class Button_Diplomacy_DecreaseRelations
extends ButtonStats {
    ...
    public Button_Diplomacy_DecreaseRelations(String sText, float iRelationDiff, int nAggressor, int nDefender, int iPosX, int iPosY, int iWidth) {
        ...
        this.sDiploCost = "" + (float)GameValues.gvRelationDecrease.COST_OFFER_DECREASE_RELATIONS_DIPLOMACY_POINTS / 10.0f;
        ...
        CFG.glyphLay.setText(CFG.fontMain.get(0), this.sRelation);
        this.iRelationWidth = (int)(CFG.glyphLay.width * 0.7f);
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        IMGManager.getIMG(Images.pix255).drawO(oSB, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 3 + (int)((float)this.getTextWidthU() * 0.7f) + iTranslateX, this.getPosY() + CFG.PADD * 2 - IMGManager.getIMG(Images.pix255).getHeight() + iTranslateY, 2, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        oSB.setColor(Color.WHITE);
        CFG.core.getCiv(this.iCivB).getFlagC().drawO(oSB, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 3 + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (CFG.TEXT_HEIGHT_DEFAULT - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall))) / 2 - CFG.core.getCiv(this.iCivB).getFlagC().getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        IMGManager.getIMG(Images.flagRectSmall).drawO(oSB, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 3 + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (CFG.TEXT_HEIGHT_DEFAULT - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall))) / 2 - IMGManager.getIMG(Images.flagRectSmall).getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        CFG.fontMain.get(0).getData().setScale(0.7f);
        CFG.drawTextDefaultWithShadow(oSB, this.getTextE(), this.getPosXE() + CFG.PADD * 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, CFG.COLOR_HOVER_TITLE);
        CFG.drawTextDefaultWithShadow(oSB, this.sRelation, this.getPosXE() + this.iCurrentRelationWidth + CFG.PADD * 2 + (int)((float)this.getTextWidthU() * 0.7f) + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, CFG.COLOR_NEGATIVE_2);
        CFG.drawTextDefaultWithShadow(oSB, this.sCurrentRelation, this.getPosXE() + CFG.PADD * 2 + (int)((float)this.getTextWidthU() * 0.7f) + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, CFG.COLOR_NEUTRAL);
        CFG.drawTextDefaultWithShadow(oSB, this.sCivBName, this.getPosXE() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADD * 4 + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) + (int)((float)this.getTextWidthU() * 0.7f) + 2 + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, this.getColorE(isActive));
        IMGManager.getIMG(Images.topDiplomacyPoints).drawO(oSB, this.getPosXE() + this.getWidthE() - CFG.PADD * 2 - (int)((float)IMGManager.getIMG(Images.topDiplomacyPoints).getWidth() * this.getImageScale(Images.topDiplomacyPoints)) + iTranslateX, this.getPosY() + CFG.PADD * 2 + (CFG.TEXT_HEIGHT_DEFAULT - (int)((float)IMGManager.getIMG(Images.topDiplomacyPoints).getHeight() * this.getImageScale(Images.topDiplomacyPoints))) / 2 - IMGManager.getIMG(Images.topDiplomacyPoints).getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.topDiplomacyPoints).getWidth() * this.getImageScale(Images.topDiplomacyPoints)), (int)((float)IMGManager.getIMG(Images.topDiplomacyPoints).getHeight() * this.getImageScale(Images.topDiplomacyPoints)));
        CFG.drawTextDefaultWithShadow(oSB, this.sDiploCost, this.getPosXE() + this.getWidthE() - CFG.PADD * 3 - this.iDiploCostWidth - (int)((float)IMGManager.getIMG(Images.topDiplomacyPoints).getWidth() * this.getImageScale(Images.topDiplomacyPoints)) + iTranslateX, this.getPosY() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f) + iTranslateY, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getDiploPoints() >= GameValues.gvRelationDecrease.COST_OFFER_DECREASE_RELATIONS_DIPLOMACY_POINTS ? Color.WHITE : CFG.COLOR_NEGATIVE_2);
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("DecreaseRelation"), CFG.COLOR_HOVER_TITLE));
