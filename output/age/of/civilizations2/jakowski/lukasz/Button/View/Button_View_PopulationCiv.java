...
public class Button_View_PopulationCiv
extends ButtonM {
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        Core.drawFlagRect(oSB, this.getPosXE() + CFG.PADD + iTranslateX, this.getPosY() + this.getHeightE() / 2 - IMGManager.getIMG(Images.flagRect2).getHeight() / 2 + iTranslateY, this.civID);
        ...
        Renderer.drawText(oSB, CFG.FONT_BOLD_SMALL, "" + this.sPopulation, this.getPosXE() + IMGManager.getIMG(Images.flagRect2).getWidth() + CFG.PADD * 2 + this.getTextWidthU() + iTranslateX, this.getPosY() + this.getHeightE() / 2 - this.getTextHeight() / 2 + iTranslateY, CFG.COLOR_POPULATION);
        IMGManager.getIMG(Images.pop).draw(oSB, this.getPosXE() + IMGManager.getIMG(Images.flagRect2).getWidth() + this.iPopulationWidth + CFG.PADD * 3 + this.getTextWidthU() + iTranslateX, this.getPosY() + this.getHeightE() / 2 - (int)((float)IMGManager.getIMG(Images.pop).getHeight() * this.getImageScale(Images.pop, 1.0f)) / 2 + iTranslateY, (int)((float)IMGManager.getIMG(Images.pop).getWidth() * this.getImageScale(Images.pop, 1.0f)), (int)((float)IMGManager.getIMG(Images.pop).getHeight() * this.getImageScale(Images.pop, 1.0f)));
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("PopulationByOrigin"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Flag_Big(this.civID, 0, CFG.PADD));
        nData.add(new ME_Hover_2Type_Text_Big(this.getTextE()));
        nData.add(new ME_Hover_2Type_Text_Big(this.sPopulation, CFG.COLOR_POPULATION));
        nData.add(new ME_Hover_2Type_Image_Big(Images.pop, CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("PercentageOfPopulation") + ": "));
        nData.add(new ME_Hover_2Type_Text(this.sPopulationPerc, CFG.COLOR_TEXT_NUM_OF_PROVINCES));
