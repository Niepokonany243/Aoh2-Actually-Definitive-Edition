...
public class Button_View_Income_ProductionBold
extends ButtonM {
    ...
    public Button_View_Income_ProductionBold(int iRow, String sText, int nProvinceID, int iPosX, int iPosY, int iWidth, boolean isFestivalOrganized) {
        ...
        CFG.glyphLay.setText(CFG.fontMain.get(CFG.FONT_BOLD_SMALL), "" + this.sProduction);
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        Renderer.drawText(oSB, CFG.FONT_BOLD_SMALL, this.sProduction, this.getPosXE() + this.getWidthE() - CFG.PADD * 3 - maxW - this.iProductionWidth - (int)((float)IMGManager.getIMG(Images.topGold()).getWidth() * this.getImageScale2(IMGManager.getIMG(Images.topGold()).getHeight())) + iTranslateX, this.getPosY() + this.getHeightE() / 2 + CFG.PADD + iTranslateY, CFG.COLOR_GOLD);
