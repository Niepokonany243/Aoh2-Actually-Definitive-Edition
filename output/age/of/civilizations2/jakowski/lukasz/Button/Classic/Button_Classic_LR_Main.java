...
public class Button_Classic_LR_Main
extends Button_Classic {
    public Button_Classic_LR_Main(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
        super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
    }

    public Button_Classic_LR_Main(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable, boolean checkboxState) {
    ...
    public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        if (CFG.settingsGD.BETTER_UI) {
            ...
            Color bg = BetterUI_Manager.getBackgroundColor(0.85f);
            ...
            // Add full borders to main clickable buttons
        ...
        if (this.getIsClickable() && this.getIsHovered() && !isActive && animationState >= 0) {
            if (animationState == 0) {
                ...
                oSB.setColor(Button_Classic_LR_Main.getColorLine());
