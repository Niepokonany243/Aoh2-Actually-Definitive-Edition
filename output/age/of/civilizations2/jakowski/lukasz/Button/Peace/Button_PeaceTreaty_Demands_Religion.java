...
public class Button_PeaceTreaty_Demands_Religion
extends ButtonM {
    public int iCivID = 0;
    ...
    public Button_PeaceTreaty_Demands_Religion(int nCivID, int toPayCivID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
        this.fontID = CFG.FONT_BOLD_SMALL;
        super.init(CFG.lang.get("ChangeReligion"), 0, iPosX, iPosY, iWidth, iHeight, isClickable, true, false, false);
        this.iCivID = nCivID;
        this.toPayCivID = toPayCivID;
        this.sValue = "" + CFG.peaceTreatyData.getReligion_Cost(toPayCivID);
    ...
    public void actionElem(int iID) {
        this.iCivID = CFG.peaceTreatyData.takeReligion(this.toPayCivID, CFG.peaceTreatyData.brushCivID, this.iCivID);
        if (CFG.menus.getInGame_PeaceTreaty()) {
            CFG.menus.rebuildInGame_PeaceTreaty_Scores();
        }
        CFG.toastM.addM(CFG.lang.get("ChangeReligion"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
