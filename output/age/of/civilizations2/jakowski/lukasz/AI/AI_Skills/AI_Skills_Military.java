...
public class AI_Skills_Military
extends AI_Skills {
    public AI_Skills_Military(int iPoints, int iPointsMax) {
    ...
    public void addPoint_CivID(int nCivID) {
        ...
        this.iPoints = CFG.core.getCiv((int)nCivID).civGD.techPoints.POINTS_MILITARY_UPKEEP;
    }

    @Override
    public float getScore_Personality(int nCivID) {
        return CFG.core.getCiv((int)nCivID).TECH_MILITARY_UPKEEP;
    }
}
