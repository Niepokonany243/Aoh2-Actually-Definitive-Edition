...
public class AI_Skills_Taxation
extends AI_Skills {
    ...
    public void addPoint_CivID(int nCivID) {
        ...
        this.iPoints = CFG.core.getCiv((int)nCivID).civGD.techPoints.POINTS_INCOME_TAXATION;
    }

    @Override
    public float getScore_Personality(int nCivID) {
        return CFG.core.getCiv((int)nCivID).TECH_TAXATION;
    }
}
