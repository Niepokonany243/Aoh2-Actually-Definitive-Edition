...
public class GV_Propaganda {
    ...
    public float PROPAGANDA_PERC_OF_FESTIVAL_HAPPINESS = 0.012f;
    public float PROPAGANDA_PERC_OF_FESTIVAL_HAPPINESS_NEIGH_PROVINCES = 0.005f;
    public float INCREASE_REV_RISK_IF_HAPPINESS_BELOW = 0.08f;
    public int INCREASE_REV_RISK_IF_HAPPINESS_BELOW_BY_VALUE_PER_TURN_RANDOM_1000 = 10;
}
