...
public class Event_Conditions_NukesLow
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv((int)this.getCivID()).civGD.iNukes >= this.getValue();
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("AtomicBombs") + " >= " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
