...
public class Event_Conditions_AssimilationsLow
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv((int)this.getCivID()).civGD.aACS < this.getValue();
        }
        catch (Exception ex) {
            return false;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("TotalAssimilationCount") + " < " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (Exception ex) {
            return CFG.lang.get("TotalAssimilationCount");
        }
    }
