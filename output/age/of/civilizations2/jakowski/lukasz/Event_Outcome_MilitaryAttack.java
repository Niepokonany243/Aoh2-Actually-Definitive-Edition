...
public class Event_Outcome_MilitaryAttack
extends Event_Outcome {
    ...
    public void outcomeAction() {
        if (this.canMakeAction()) {
            ...
            CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseAttack = Math.max(0, (int)(CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseAttack + this.getValue()));
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Attack") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + ", " + (this.getValue() > 0 ? "+" : "") + this.getValue();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Attack");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Attack") + ": "));
                ...
                tData.add(new ME_Hover_2Type_Image(Images.attack, CFG.PADD, 0));
