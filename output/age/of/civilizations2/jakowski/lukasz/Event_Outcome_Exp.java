...
public class Event_Outcome_Exp
extends Event_Outcome {
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("RevolutionaryMovements") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + " -> " + CFG.lang.get("Explode");
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("RevolutionaryMovements");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("RevolutionaryMovements")));
