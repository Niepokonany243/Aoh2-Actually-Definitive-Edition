...
public class Message_Rivals
extends Message {
    public Message_Rivals(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.RIVALS;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("RivaledBy") + ": " + CFG.core.getCiv(this.fromCivID).getCivName());
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Rivalry")));
