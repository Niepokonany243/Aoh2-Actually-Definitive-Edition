...
public class Message_Relations_Friendly
extends Message {
    public Message_Relations_Friendly(int byCivID) {
        super(byCivID, 0);
        this.messageType = MessageType.RELATIONS_FRIENDLY;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("FriendlyCivilizations"));
