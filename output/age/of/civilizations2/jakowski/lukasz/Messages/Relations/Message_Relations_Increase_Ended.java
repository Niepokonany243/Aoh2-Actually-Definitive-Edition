...
public class Message_Relations_Increase_Ended
extends Message {
    public Message_Relations_Increase_Ended(int byCivID) {
        super(byCivID, 0);
        this.messageType = MessageType.RELATIONS_INCREASE_ENDED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("TheDiplomatEndedImprovingRelationsBetweenOurCivilizations"));
            lColors.add(CFG.COLOR_TEXT_NUM_OF_PROVINCES);
            lMess.add(CFG.core.getCiv(this.fromCivID).getCivName() + " - " + CFG.core.getCiv(iCivID).getCivName());
    ...
    public int getImageID() {
        return Images.diploRelationsInc;
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("TheDiplomatEndedImprovingRelationsBetweenOurCivilizations"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
