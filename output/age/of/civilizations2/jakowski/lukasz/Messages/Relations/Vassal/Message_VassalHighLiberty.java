...
package age.of.civilizations2.jakowski.lukasz.Messages.Relations.Vassal;
...
public class Message_VassalHighLiberty
extends Message {
    public Message_VassalHighLiberty(int fromCivID) {
        super(fromCivID, -1);
        this.messageType = MessageType.VASSAL_HIGH_LIBERTY;
    ...
    public void onAccept(int iCivID) {
        CFG.menus.rebuildMenu_InGame_LibertyDisere(this.fromCivID);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big((int)CFG.core.getCiv(this.fromCivID).getVassalLibertyDesire() + "%", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
