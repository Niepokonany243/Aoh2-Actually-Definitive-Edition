...
public class Message_SummitIsOver
extends Message {
    public Message_SummitIsOver(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.DIPLOMATIC_SUMMIT_IS_OVER;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("DiplomaticSummitOver"));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("DiplomaticSummitOver")));
