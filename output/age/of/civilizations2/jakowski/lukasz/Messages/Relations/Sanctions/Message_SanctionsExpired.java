...
public class Message_SanctionsExpired
extends Message {
    public Message_SanctionsExpired(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.SANCTIONS_EXPIRED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("SanctionsHaveExpired"));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("SanctionsHaveExpired")));
