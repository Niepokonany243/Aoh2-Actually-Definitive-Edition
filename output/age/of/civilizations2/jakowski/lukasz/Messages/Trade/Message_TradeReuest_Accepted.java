...
public class Message_TradeReuest_Accepted
extends Message {
    public Message_TradeReuest_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.TRADE_REQUEST_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("TradeRequest") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("TradeRequest") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("OurProposalWasAccepted"), CFG.COLOR_HOVER_TITLE));
