...
public class Message_TradeReuest_Denied
extends Message {
    public Message_TradeReuest_Denied(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.TRADE_REQUEST_DENIED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("TradeRequest") + ": " + CFG.lang.get("ProposalWasRejected"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
