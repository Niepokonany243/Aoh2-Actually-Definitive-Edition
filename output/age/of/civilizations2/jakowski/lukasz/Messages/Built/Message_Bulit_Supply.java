...
public class Message_Bulit_Supply
extends Message {
    public Message_Bulit_Supply(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BUILT_SUPPLY;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + CFG.lang.get(BuildingsManager.getSupply_Name(CFG.core.getProv((int)this.iValue).getLvlOfSupply())));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getSupply_Name(CFG.core.getProv((int)this.iValue).getLvlOfSupply())), CFG.COLOR_HOVER_TITLE));
        ...
        nData.add(new ME_Hover_2Type_Text("-" + (int)(BuildingsManager.getSupply_Bonus(CFG.core.getProv((int)this.iValue).getLvlOfSupply()) * 100.0f) + "%", CFG.COLOR_POSITIVE));
