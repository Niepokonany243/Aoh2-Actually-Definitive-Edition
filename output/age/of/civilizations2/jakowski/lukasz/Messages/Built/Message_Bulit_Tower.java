...
public class Message_Bulit_Tower
extends Message {
    public Message_Bulit_Tower(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BULIT_TOWER;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + CFG.lang.get(BuildingsManager.getTower_Name(CFG.core.getProv((int)this.iValue).getLvlOfWatchTower())));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getTower_Name(CFG.core.getProv((int)this.iValue).getLvlOfWatchTower())), CFG.COLOR_HOVER_TITLE));
        ...
        nData.add(new ME_Hover_2Type_Text("+" + BuildingsManager.getTower_DefenseBonus(CFG.core.getProv((int)this.iValue).getLvlOfWatchTower()) + "%", CFG.COLOR_POSITIVE));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
