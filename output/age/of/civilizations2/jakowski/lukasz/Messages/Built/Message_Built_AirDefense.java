...
public class Message_Built_AirDefense extends Message {
    public Message_Built_AirDefense(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BUILT_AIR_DEFENSE;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + BuildingsManager.getAirDefense_Name(CFG.core.getProv((int)this.iValue).provGD.iAirDefense));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(BuildingsManager.getAirDefense_Name(CFG.core.getProv((int)this.iValue).provGD.iAirDefense), CFG.COLOR_HOVER_TITLE));
        nData.add(new ME_Hover_2Type_Image_Big(Images.bSupply, CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(" - "));
        nData.add(new ME_Hover_2Type_Text("Reduces tactical missile strike damage in this province.", CFG.COLOR_HOVER_TITLE));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
