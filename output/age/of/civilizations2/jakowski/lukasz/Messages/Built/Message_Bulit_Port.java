...
public class Message_Bulit_Port
extends Message {
    public Message_Bulit_Port(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BULIT_PORT;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + CFG.lang.get(BuildingsManager.getPort_Name(CFG.core.getProv((int)this.iValue).getLvlOfPort())));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getPort_Name(CFG.core.getProv((int)this.iValue).getLvlOfPort())), CFG.COLOR_HOVER_TITLE));
        ...
        nData.add(new ME_Hover_2Type_Text("+" + (int)(BuildingsManager.getPort_IncomeProduction(CFG.core.getProv((int)this.iValue).getLvlOfPort()) * 100.0f) + "%", CFG.COLOR_POSITIVE));
