...
public class Message_Built_Library
extends Message {
    public Message_Built_Library(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BULIT_LIBRARY;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + CFG.lang.get(BuildingsManager.getLibrary_Name(CFG.core.getProv((int)this.iValue).getLvlOfLibrary())));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() : CFG.lang.get("Province")));
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getLibrary_Name(CFG.core.getProv((int)this.iValue).getLvlOfLibrary())), CFG.COLOR_HOVER_TITLE));
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ResearchPerTurnForEveryXPeopleInProvince", BuildingsManager.getLibrary_ResearchPerPopulation(CFG.core.getProv((int)this.iValue).getLvlOfLibrary())), CFG.COLOR_HOVER_TITLE));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
