...
public class Message_Bulit_Farm
extends Message {
    public Message_Bulit_Farm(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.BULIT_FARM;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add((CFG.core.getProv((int)this.iValue).getName().length() > 0 ? CFG.core.getProv((int)this.iValue).getName() + ": " : "") + CFG.lang.get(BuildingsManager.getFarm_Name(CFG.core.getProv((int)this.iValue).getLvlOfFarm())));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getFarm_Name(CFG.core.getProv((int)this.iValue).getLvlOfFarm())), CFG.COLOR_HOVER_TITLE));
        ...
        nData.add(new ME_Hover_2Type_Text("+" + (int)(BuildingsManager.getFarm_GrowthRateBonus(CFG.core.getProv((int)this.iValue).getLvlOfFarm()) * 100.0f) + "%", CFG.COLOR_POSITIVE));
