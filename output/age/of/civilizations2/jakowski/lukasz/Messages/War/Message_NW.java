...
public class Message_NW
extends Message {
    public Message_NW(int warDeclareByCivID, int onCivID) {
        super(warDeclareByCivID, onCivID);
        this.messageType = MessageType.NEIGH_WAR;
    ...
    public void onAccept(int iCivID) {
        CFG.menus.rebuildMenu_InGame_NeighWar(this.fromCivID, (int)this.iValue);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Image_Big(Images.neighWar, CFG.PADD, CFG.PADD));
