...
public class Message_War_CivIsAtWar
extends Message {
    public Message_War_CivIsAtWar(int warDeclareByCivID, int onCivID) {
        super(warDeclareByCivID, onCivID);
        this.messageType = MessageType.WAR_CIVISATWAR;
    ...
    public void onAccept(int iCivID) {
        CFG.menus.rebuildMenu_InGame_War(this.fromCivID, (int)this.iValue);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("CivAIsNowAtWarWithCivB"), CFG.COLOR_NEGATIVE_2));
        nData.add(new ME_Hover_2Type_Flag_Big(this.fromCivID, CFG.PADD, CFG.PADD));
