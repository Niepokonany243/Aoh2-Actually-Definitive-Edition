 ...
 */
package age.of.civilizations2.jakowski.lukasz.Messages.Vassal;
...
public class Message_OfferVasalization
extends Message {
    public Message_OfferVasalization(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.OFFERVASALIZATION;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_OfferVasalization(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptOfferVassalization(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineOfferVassalization(iCivID, this.fromCivID, (int)this.iValue);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("Vassal"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_Image(this.getImageID(), CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Flag_Big(this.fromCivID));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("BecomeAVassalOf", CFG.core.getCiv(this.fromCivID).getCivName())));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
