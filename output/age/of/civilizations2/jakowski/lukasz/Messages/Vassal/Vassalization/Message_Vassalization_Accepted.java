 ...
 */
package age.of.civilizations2.jakowski.lukasz.Messages.Vassal.Vassalization;
...
public class Message_Vassalization_Accepted
extends Message {
    public Message_Vassalization_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.VASSALIZATION_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.core.getCiv(this.fromCivID).getCivName() + ": " + CFG.lang.get("OurProposalWasAccepted"));
            lColors.add(CFG.COLOR_POSITIVE);
            CFG.toastM.addM(lMess, lColors);
            CFG.toastM.setTimeInView(4500);
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("OfferVassalization") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("OfferVassalization"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.core.getCiv(this.fromCivID).getCivName() + ": "));
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("OurProposalWasAccepted"), CFG.COLOR_POSITIVE));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
