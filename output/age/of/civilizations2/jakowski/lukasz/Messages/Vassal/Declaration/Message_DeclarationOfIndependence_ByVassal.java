...
package age.of.civilizations2.jakowski.lukasz.Messages.Vassal.Declaration;
...
public class Message_DeclarationOfIndependence_ByVassal
extends Message {
    public Message_DeclarationOfIndependence_ByVassal(int byCivID) {
        super(byCivID, 0);
        this.messageType = MessageType.DECLARATION_OF_INDEPENDENCE_BYVASSAl;
    ...
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_DeclarationOfIndependence_ByVassal(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.vassalDeclareIndependence_War(iCivID, this.fromCivID);
    }

    @Override
    public void onDecline(int iCivID) {
        CFG.core.whitePeace_ReturnProvincesToRightfulOwners(iCivID, this.fromCivID);
        GameManager.vassalDeclareIndependence_Fine(iCivID, this.fromCivID);
    }

    @Override
    public int getImageID() {
        return Images.diploRevolution;
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("DeclarationOfIndependence") + ": "));
