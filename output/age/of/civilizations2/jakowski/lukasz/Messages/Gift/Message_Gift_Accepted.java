...
public class Message_Gift_Accepted
extends Message {
    public Message_Gift_Accepted(int fromCivID, long iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.GIFT_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("Gift") + " - " + CFG.lang.get("Accepted"));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Accepted"), CFG.COLOR_POSITIVE));
