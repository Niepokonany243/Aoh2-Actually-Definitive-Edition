...
public class Message_Gift_Refused
extends Message {
    public Message_Gift_Refused(int fromCivID, long iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.GIFT_REFUSED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("XRefusedToAcceptOurGift", CFG.core.getCiv(this.fromCivID).getCivName()));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("GiftSentBack"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_Text_Big(" " + CFG.getNumberWthSpaces("" + this.iValue), CFG.COLOR_GOLD));
        nData.add(new ME_Hover_2Type_Image_Big(Images.topGold(), CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Flag(this.fromCivID));
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("XRefusedToAcceptOurGift", CFG.core.getCiv(this.fromCivID).getCivName()), CFG.COLOR_NEGATIVE_2));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
