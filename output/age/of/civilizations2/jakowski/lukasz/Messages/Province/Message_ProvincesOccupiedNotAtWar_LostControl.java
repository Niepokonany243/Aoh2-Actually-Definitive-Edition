...
public class Message_ProvincesOccupiedNotAtWar_LostControl
extends Message {
    public Message_ProvincesOccupiedNotAtWar_LostControl(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.PROVINCES_LOST_CONTROL;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            CFG.toastM.addM(CFG.lang.get("LostControlOverProvince"), CFG.COLOR_NEGATIVE_2);
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("LostControlOverProvince") + ": ", CFG.COLOR_NEGATIVE_2));
        ...
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("RightfulOwner") + ":", CFG.COLOR_NEGATIVE_2));
