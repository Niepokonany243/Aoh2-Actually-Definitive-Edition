...
public class Message_ProvincesNotSupplied_Straves
extends Message {
    public Message_ProvincesNotSupplied_Straves(int fromCivID, int iProvinceID, int iValue) {
        super(fromCivID, iValue);
        this.iValue2 = iProvinceID;
        this.messageType = MessageType.PROVINCES_NOT_SUPPLIED_STRAVES;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            CFG.toastM.addM(CFG.lang.get("ArmyStarvesToDeath") + ": -" + CFG.getNumberWthSpaces("" + this.iValue) + " " + CFG.lang.get("Units"), CFG.COLOR_NEGATIVE_2);
            CFG.toastM.setTimeInView(3500);
            CFG.core.setActiveProvID((int)this.iValue2);
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("ArmyStarvesToDeath") + ": "));
        nData.add(new ME_Hover_2Type_Text_Big("-" + CFG.getNumberWthSpaces("" + this.iValue) + " " + CFG.lang.get("Units"), CFG.COLOR_NEGATIVE_2));
        nData.add(new ME_Hover_2Type_Image_Big(Images.diploArmy, CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ProvinceIsNotSupplied"), CFG.COLOR_NEGATIVE_2));
