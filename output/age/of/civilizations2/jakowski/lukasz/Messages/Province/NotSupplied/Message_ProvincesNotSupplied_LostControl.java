...
public class Message_ProvincesNotSupplied_LostControl
extends Message {
    public Message_ProvincesNotSupplied_LostControl(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.PROVINCES_NOT_SUPPLIED_LOST_CONTROL;
