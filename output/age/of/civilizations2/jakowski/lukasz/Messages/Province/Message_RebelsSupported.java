...
public class Message_RebelsSupported
extends Message {
    public Message_RebelsSupported(int byCivID, int nProvinceID) {
        super(byCivID, nProvinceID);
        this.messageType = MessageType.REBELS_SUPPORTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            CFG.toastM.addM(CFG.lang.get("CivXRevolutionaryMovementHasBeenUnusuallyStrongately", CFG.core.getCiv(this.fromCivID).getCivName()), CFG.COLOR_NEGATIVE_2);
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("CivXRevolutionaryMovementHasBeenUnusuallyStrongately", CFG.core.getCiv(this.fromCivID).getCivName()), CFG.COLOR_NEGATIVE_2));
