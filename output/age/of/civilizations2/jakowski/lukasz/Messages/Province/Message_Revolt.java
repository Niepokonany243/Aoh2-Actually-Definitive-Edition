...
public class Message_Revolt
extends Message {
    public Message_Revolt(int byCivID, int nProvinceID) {
        super(byCivID, nProvinceID);
        this.messageType = MessageType.REVOLT;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID && !CFG.SPECTATOR_MODE) {
            ...
            CFG.toastM.addM(CFG.lang.get("Revolt"), CFG.COLOR_NEGATIVE_2);
            CFG.menus.rebuildMenu_InGame_InfoBox_Revolt();
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Revolt"), CFG.COLOR_NEGATIVE_2));
