...
public class Message_UltimatumRefused
extends Message {
    public Message_UltimatumRefused(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.ULTIMATUM_REFUSED;
        this.numOfTurnsLeft = 2;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_UltimatumRefused(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.refuseUltimatum_AcceptWar(iCivID, this.fromCivID);
    }
