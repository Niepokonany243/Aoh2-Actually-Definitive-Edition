...
package age.of.civilizations2.jakowski.lukasz.Messages.DefensivePact;
...
public class Message_DefensivePact
extends Message {
    public Message_DefensivePact(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.DEFENSIVEPACT;
        this.requestsResponse = GameValues.gvDipDefensivePact.DEFENSIVE_PACT_REQUESTS_RESPONSE;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_DefensivePact(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptDefensivePact(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineDefensivePact(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public int getImageID() {
        return Images.diploDefensivePact;
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("SignDefensivePactWithCivA", CFG.core.getCiv(this.fromCivID).getCivName())));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
