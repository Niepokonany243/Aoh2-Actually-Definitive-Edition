...
public class Message_DefensivePact_Accepted
extends Message {
    public Message_DefensivePact_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.DEFENSIVEPACT_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("DefensivePact") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
