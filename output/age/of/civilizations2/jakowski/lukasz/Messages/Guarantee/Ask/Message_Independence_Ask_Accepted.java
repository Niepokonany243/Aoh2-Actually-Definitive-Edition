...
public class Message_Independence_Ask_Accepted
extends Message {
    public Message_Independence_Ask_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.GUARANTEE_ASK_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("GuaranteeIndependence") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
