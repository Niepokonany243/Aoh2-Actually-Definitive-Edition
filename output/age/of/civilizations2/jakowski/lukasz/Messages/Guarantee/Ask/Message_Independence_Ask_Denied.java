...
public class Message_Independence_Ask_Denied
extends Message {
    public Message_Independence_Ask_Denied(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.GUARANTEE_ASK_DENIED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("GuaranteeIndependence") + ": " + CFG.lang.get("ProposalWasRejected"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
