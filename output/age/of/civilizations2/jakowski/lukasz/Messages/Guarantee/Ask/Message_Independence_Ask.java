...
package age.of.civilizations2.jakowski.lukasz.Messages.Guarantee.Ask;
...
public class Message_Independence_Ask
extends Message {
    public Message_Independence_Ask(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.GUARANTEE_ASK;
        this.requestsResponse = GameValues.gvDipGuarantee.GUARANTEE_REQUESTS_RESPONSE;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_Independence_Ask(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptGuaranteeIndependence_Ask(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineGuaranteeIndependence_Ask(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public int getImageID() {
        return Images.diploGuaranteeGives;
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("CivAWantsToGuaranteeOurIndependence", CFG.core.getCiv(this.fromCivID).getCivName())));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
