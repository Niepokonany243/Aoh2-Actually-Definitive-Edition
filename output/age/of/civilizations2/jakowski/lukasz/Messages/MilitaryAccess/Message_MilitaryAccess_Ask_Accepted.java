...
public class Message_MilitaryAccess_Ask_Accepted
extends Message {
    public Message_MilitaryAccess_Ask_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.MILITARY_ACCESS_ASK_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("OurProposalWasAccepted"));
            lColors.add(CFG.COLOR_POSITIVE);
            CFG.toastM.addM(lMess, lColors);
            CFG.toastM.setTimeInView(4500);
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("MilitaryAccess") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("OurProposalWasAccepted"), CFG.COLOR_POSITIVE));
