 ...
 */
package age.of.civilizations2.jakowski.lukasz.Messages.MilitaryAccess;
...
public class Message_MilitaryAccess_Give
extends Message {
    public Message_MilitaryAccess_Give(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.MILITARY_ACCESS_GIVE;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_MilitaryAccess_Give(this.fromCivID, iMessageID, (int)this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptMilitaryAccess_Give(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineMilitaryAccess_Give(iCivID, this.fromCivID, (int)this.iValue);
    }

    @Override
    public int getImageID() {
        return Images.diploAccessGives;
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("MilitaryAccess"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_Image_Big(this.getImageID(), CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Flag_Big(this.fromCivID));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("GainMilitaryAccessToCivA", CFG.core.getCiv(this.fromCivID).getCivName())));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
