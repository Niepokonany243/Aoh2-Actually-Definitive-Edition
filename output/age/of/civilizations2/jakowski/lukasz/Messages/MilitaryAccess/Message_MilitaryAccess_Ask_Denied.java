...
public class Message_MilitaryAccess_Ask_Denied
extends Message {
    public Message_MilitaryAccess_Ask_Denied(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.MILITARY_ACCESS_ASK_DENIED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("ProposalWasRejected"));
            lColors.add(CFG.COLOR_NEGATIVE_2);
            CFG.toastM.addM(lMess, lColors);
            CFG.toastM.setTimeInView(4500);
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("MilitaryAccess") + ": " + CFG.lang.get("ProposalWasRejected"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("ProposalWasRejected"), CFG.COLOR_NEGATIVE_2));
