...
public class Message_NTR
extends Message {
    public Message_NTR(int warDeclareByCivID, int onCivID) {
        super(warDeclareByCivID, onCivID);
        this.messageType = MessageType.NEIGH_TRUCE;
    ...
    public void onAccept(int iCivID) {
        CFG.menus.rebuildMenu_InGame_NeighTruce(this.fromCivID, (int)this.iValue);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("NeighboringCivilizationSignedPeaceTreaty") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        nData.add(new ME_Hover_2Type_Image_Big(Images.neighTruce, CFG.PADD, CFG.PADD));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.core.getCiv((int)this.iValue).getCivName()));
        nData.add(new ME_Hover_2Type_Flag_Big((int)this.iValue, CFG.PADD, 0));
