...
public class Message_PeaceTreaty_Rejected
extends Message {
    public Message_PeaceTreaty_Rejected(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.PEACE_TREATY_REJECTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("PeaceTreaty") + ": " + CFG.lang.get("ProposalWasRejected"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
