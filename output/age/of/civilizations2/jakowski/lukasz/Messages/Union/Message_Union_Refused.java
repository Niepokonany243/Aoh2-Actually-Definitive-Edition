...
public class Message_Union_Refused
extends Message {
    public Message_Union_Refused(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.UNION_REFUSED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("XRefusedToFormUnion", CFG.core.getCiv(this.fromCivID).getCivName()));
            lColors.add(CFG.COLOR_NEGATIVE_2);
            CFG.toastM.addM(lMess, lColors);
            CFG.toastM.setTimeInView(4500);
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("XRefusedToFormUnion", CFG.core.getCiv(this.fromCivID).getCivName()), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("XRefusedToFormUnion", CFG.core.getCiv(this.fromCivID).getCivName()), CFG.COLOR_NEGATIVE_2));
