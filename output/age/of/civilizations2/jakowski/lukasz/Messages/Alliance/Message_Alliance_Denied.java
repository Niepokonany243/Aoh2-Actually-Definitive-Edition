...
public class Message_Alliance_Denied
extends Message {
    public Message_Alliance_Denied(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.ALLIANCE_DENIED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("AllianceProposalWasRejected"));
            lColors.add(CFG.COLOR_NEGATIVE_2);
            CFG.toastM.addM(lMess, lColors);
            CFG.toastM.setTimeInView(4500);
            CFG.menus.rebuildMenu_InGame_Infobox(CFG.lang.get("AllianceProposalWasRejected"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("AllianceProposalWasRejected"), CFG.COLOR_NEGATIVE_2));
