...
public class Message_HRE_Elections_NewEmperor
extends Message {
    public Message_HRE_Elections_NewEmperor(int byCivID) {
        super(byCivID, 0);
        this.messageType = MessageType.HRE_NEW_EMPEROR;
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Emperor") + ": "));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.core.getCiv(this.fromCivID).getCivName(), CFG.COLOR_HOVER_TITLE));
        nData.add(new ME_Hover_2Type_Image_Big(Images.hreCrown, CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
