...
public class Message_InvestmentsLow
extends Message {
    public Message_InvestmentsLow(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.INVESTMENTS_LOW;
        this.numOfTurnsLeft = 2;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.toastM.addM(CFG.lang.get("DevelopmentLevelAndEconomyWillBeIncreased"), CFG.COLOR_NEGATIVE_2);
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Investments"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_TextDesc(CFG.lang.get("DevelopmentLevelAndEconomyWillBeIncreased"), CFG.COLOR_NEGATIVE_2));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
