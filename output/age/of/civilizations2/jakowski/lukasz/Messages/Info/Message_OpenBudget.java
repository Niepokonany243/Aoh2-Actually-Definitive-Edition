...
public class Message_OpenBudget
extends Message {
    public Message_OpenBudget(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.BUDGET;
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("OpenTheViewOfYourCivilizationsBudget"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
