...
public class Message_Repaid
extends Message {
    public Message_Repaid(int fromCivID, int iValue) {
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            CFG.toastM.addM(CFG.lang.get("LoanRepaid"), CFG.COLOR_POSITIVE);
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("LoanRepaid"), CFG.COLOR_HOVER_TITLE));
