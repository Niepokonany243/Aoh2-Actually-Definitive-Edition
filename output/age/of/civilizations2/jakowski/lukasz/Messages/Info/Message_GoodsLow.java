...
public class Message_GoodsLow
extends Message {
    public Message_GoodsLow(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.GOODS_LOW;
        this.numOfTurnsLeft = 2;
    }

    @Override
    public void onAction(int iMessageID) {
        CFG.toastM.addM(CFG.lang.get("hGoods3", (int)(CFG.ideologiesMgr.getIdeologyID(CFG.core.getCiv(this.fromCivID).getIdeology()).getMin_Goods(this.fromCivID) * 100.0f)), CFG.COLOR_NEGATIVE_2);
        ...
        if (!CFG.menus.getVisible_InGame_FlagAction() && !CFG.menus.getVisible_InGame_Budget()) {
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("BudgetSpendings"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nData.add(new ME_Hover_2Type_Text_Big(" -> ", CFG.COLOR_NEUTRAL));
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Goods"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_TextDesc(CFG.lang.get("hGoods3", (int)(CFG.ideologiesMgr.getIdeologyID(CFG.core.getCiv(this.fromCivID).getIdeology()).getMin_Goods(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()) * 100.0f)), CFG.COLOR_NEGATIVE_2));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_TextDesc(CFG.lang.get("hGoods4")));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
