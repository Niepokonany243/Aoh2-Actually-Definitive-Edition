...
public class Message_FestivalIsOver
extends Message {
    public Message_FestivalIsOver(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.FESTIVAL_IS_OVER;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("FestivalIsOver"));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("FestivalIsOver")));
        ...
        nData.add(new ME_Hover_2Type_Text("" + (int)(CFG.core.getProv((int)this.iValue).getHappi() * 100.0f) + "%", CFG.COLOR_HAPPINESS_MAX));
        nData.add(new ME_Hover_2Type_Image(CFG.getHappinessImage((int)(CFG.core.getProv((int)this.iValue).getHappi() * 100.0f)), CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
