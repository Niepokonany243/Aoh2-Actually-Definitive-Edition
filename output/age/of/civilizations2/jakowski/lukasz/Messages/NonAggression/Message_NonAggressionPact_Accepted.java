...
public class Message_NonAggressionPact_Accepted
extends Message {
    public Message_NonAggressionPact_Accepted(int fromCivID) {
        super(fromCivID, 0);
        this.messageType = MessageType.NONAGGRESSIONPACT_ACCEPTED;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            CFG.menus.rebuildMenu_InGame_InfoboxSmallFlags(CFG.lang.get("NonAggressionPact") + ": " + CFG.lang.get("OurProposalWasAccepted"), iCivID, this.fromCivID, Images.infoDiplomacy);
        }
    }
