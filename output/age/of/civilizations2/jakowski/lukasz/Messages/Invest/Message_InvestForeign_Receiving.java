...
public class Message_InvestForeign_Receiving
extends Message {
    public long gold = 0L;
    public long profit = 0L;

    public Message_InvestForeign_Receiving(int fromCivID, int iValue, long gold, long profit) {
        super(fromCivID, iValue);
        this.gold = gold;
        this.profit = profit;
        this.messageType = MessageType.RECEIVING_FOREIGN_INVEST;
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("ReceivingForeignInvestment") + ": " + CFG.lang.get("Gold") + ": " + CFG.getNumberWthSpaces("" + this.gold) + ", " + CFG.lang.get("Profit") + ": " + CFG.getNumberWthSpaces("" + this.profit));
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("ReceivingForeignInvestment")));
