...
public class Message_InvestDoneForeign
extends Message {
    public long gold = 0L;
    public long profit = 0L;

    public Message_InvestDoneForeign(int fromCivID, int iValue, long gold, long profit) {
        super(fromCivID, iValue);
        this.gold = gold;
        this.profit = profit;
        this.messageType = MessageType.INVEST_IS_OVER_FOREIGN;
