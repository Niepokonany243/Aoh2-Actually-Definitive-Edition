...
public class Message_InvestDone
extends Message {
    public Message_InvestDone(int fromCivID, int iValue) {
        super(fromCivID, iValue);
        this.messageType = MessageType.INVEST_IS_OVER;
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text("" + CFG.getNumberWthSpaces("" + CFG.core.getProv((int)this.iValue).getEco()), CFG.COLOR_ECONOMY));
