...
public class Menu_CreateScenario_Events_Out_Exp
extends Menu {
    public Menu_CreateScenario_Events_Out_Exp() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("RevolutionaryMovements") + ": " + CFG.lang.get("Explode"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_EXP;
