...
public class Graph_Vertical_Data_Value_Continent
extends Graph_Vertical_Data_Value {
    public Graph_Vertical_Data_Value_Continent(int iValue, int iColorDataID) {
    ...
    public final Color getColor(float fAlpha) {
        try {
            return new Color(CFG.map.getMapContinents().getColor((int)this.iColorDataID).r, CFG.map.getMapContinents().getColor((int)this.iColorDataID).g, CFG.map.getMapContinents().getColor((int)this.iColorDataID).b, fAlpha);
        }
