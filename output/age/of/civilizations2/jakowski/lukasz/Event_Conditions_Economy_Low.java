...
public class Event_Conditions_Economy_Low
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            ...
            for (int i = 0; i < CFG.core.getCiv(this.getCivID()).getNumOfProvs(); ++i) {
                tNum += CFG.core.getProv(CFG.core.getCiv(this.getCivID()).getProvID(i)).getEco();
            }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("Economy") + " < " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
