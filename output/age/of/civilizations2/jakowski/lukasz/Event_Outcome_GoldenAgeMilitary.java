...
public class Event_Outcome_GoldenAgeMilitary
extends Event_Outcome {
    ...
    public void outcomeAction() {
        try {
            if (this.canMakeAction()) {
                GameManager.goldenAge_Military(this.getCivID());
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAMilitary") + ": " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAMilitary");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text("" + CFG.lang.get("GAMilitary"), CFG.COLOR_HOVER_TITLE));
                tData.add(new ME_Hover_2Type_Image(Images.diploGoldenAgeM, CFG.PADD, 0));
