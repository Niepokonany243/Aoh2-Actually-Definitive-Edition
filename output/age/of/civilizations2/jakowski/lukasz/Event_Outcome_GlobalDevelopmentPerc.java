...
public class Event_Outcome_GlobalDevelopmentPerc
extends Event_Outcome {
    ...
    public void outcomeAction() {
        try {
            for (int i = 0; i < CFG.core.getProvinSize(); ++i) {
                ...
                CFG.core.getProv(i).setDevLvl(CFG.core.getProv(i).getDeveLvl() * (1.0f + (float)this.iValue / 1000.0f));
            }
        }
        catch (Exception ex) {
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("Development") + ": " + CFG.getPrecision2((float)this.getValue() / 10.0f, 100) + "%";
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("Development");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            tData.add(new ME_Hover_2Type_Text(CFG.lang.get("Development") + ": "));
    ...
    public final void editViewID() {
        CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_OUT_GLOBAL_DEV_PERC);
    }
}
