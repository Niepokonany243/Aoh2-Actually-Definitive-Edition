...
public class Event_Conditions_DefensivePact
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getDefensivePact(this.getCivID(), this.getCivID2()) > 0;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("DefensivePact") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + " - " + CFG.core.getCiv(this.getCivID2()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
