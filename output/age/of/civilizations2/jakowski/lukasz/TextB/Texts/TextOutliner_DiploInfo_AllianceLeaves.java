...
public class TextOutliner_DiploInfo_AllianceLeaves
extends Text {
    ...
    public TextOutliner_DiploInfo_AllianceLeaves(int iCivLeft, String sAllianceName, int iTurnID, int iPosX, int iPosY, int nWidth) {
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(" " + CFG.lang.get("CivAIsNoLongerAMemberOf") + " ", CFG.COLOR_HOVER_TITLE));
        nData.add(new ME_Hover_2Type_Text_Big(this.sAllianceName));
