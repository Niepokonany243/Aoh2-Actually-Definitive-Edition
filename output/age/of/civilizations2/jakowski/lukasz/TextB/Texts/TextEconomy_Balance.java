...
public class TextEconomy_Balance
extends Text {
    public String sText2;
    public Color textColor;

    public TextEconomy_Balance(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
