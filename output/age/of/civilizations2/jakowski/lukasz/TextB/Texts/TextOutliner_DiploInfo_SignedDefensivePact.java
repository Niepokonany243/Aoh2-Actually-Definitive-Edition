...
public class TextOutliner_DiploInfo_SignedDefensivePact
extends Text {
    ...
    public TextOutliner_DiploInfo_SignedDefensivePact(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("DefensivePact"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
