...
public class TextOutliner_DiploInfo_Guarantee
extends Text {
    ...
    public TextOutliner_DiploInfo_Guarantee(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("GuaranteeIndependence"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        nData.add(new ME_Hover_2Type_Image_Big(Images.diploGuaranteeGives, CFG.PADD, CFG.PADD));
    ...
    public void actionElem(int iID) {
        CFG.toastM.addM((this.iCivLeft >= 0 ? CFG.core.getCiv(this.iCivLeft).getCivName() : CFG.lang.get("Undiscovered")) + " - " + CFG.lang.get("DefensivePact") + " - " + (this.iCivRight >= 0 ? CFG.core.getCiv(this.iCivRight).getCivName() : CFG.lang.get("Undiscovered")), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
    }
}
