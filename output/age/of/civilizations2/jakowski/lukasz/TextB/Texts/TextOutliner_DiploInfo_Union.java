...
public class TextOutliner_DiploInfo_Union
extends Text {
    ...
    public TextOutliner_DiploInfo_Union(int iCivLeft, int iTurnID, int iPosX, int iPosY, int nWidth) {
        super(CFG.lang.get("Union"), CFG.PADD * 2, iPosX, iPosY, nWidth, CFG.CIV_FLAG_HEIGHT + CFG.PADD * 2);
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Union"), CFG.COLOR_HOVER_TITLE));
    ...
    public void actionElem(int iID) {
        CFG.toastM.addM(this.iCivLeft >= 0 ? CFG.core.getCiv(this.iCivLeft).getCivName() : CFG.lang.get("Undiscovered"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
    }
