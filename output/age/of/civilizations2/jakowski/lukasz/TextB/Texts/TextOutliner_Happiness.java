...
public class TextOutliner_Happiness
extends Text {
    ...
    public TextOutliner_Happiness(int nCivID, String researchProgress, int iPosX, int iPosY, int iWidth) {
        ...
        this.iCivID = nCivID;
        this.colorText = CFG.core.getCiv(nCivID).getHappiness() < 50 ? CFG.COLOR_HAPPINESS_MIN : CFG.COLOR_TEXT_GRAY_NS;
        if (this.getWidthE() > iWidth) {
            this.setWidthE(iWidth);
        }
        int nIMGID = Images.happiness;
    ...
    public void setTextE(String sText) {
        ...
        try {
            ...
            this.colorText = CFG.getColorStep(CFG.COLOR_HAPPINESS_MIN, CFG.COLOR_HAPPINESS_MAX, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getHappiness(), 100, 1.0f);
