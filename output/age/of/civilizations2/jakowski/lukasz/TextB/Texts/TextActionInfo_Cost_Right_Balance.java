...
public class TextActionInfo_Cost_Right_Balance
extends TextActionInfo {
    public long iNumOfUnits = 0;
    private String sBalance;
    private int iBalanceWidth = 0;
    private int iBalance = 0;
    private Color oColorBalance = CFG.COLOR_POSITIVE;

    public TextActionInfo_Cost_Right_Balance(String sText, int iPosX, int iPosY) {
    ...
    public void setCurr(long nCurrent) {
        ...
        int tempNewBalance = (int)((float)this.iBalance - CFG.gameUpdate.getMilitaryUpkeep_WithAllRecruitmentsInProcess(CFG.core.getActiveProvID(), this.iNumOfUnits, CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()));
