...
public class TextOutliner_WarWeariness
extends Text {
    ...
    public TextOutliner_WarWeariness(int nCivID, String researchProgress, int iPosX, int iPosY, int iWidth) {
        ...
        int nIMGID = Images.diploWeariness;
    ...
    public void drawE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
        ...
        int imgID = Images.diploWeariness;
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big("" + (float)((int)(CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getWarWeariness() * 10000.0f)) / 100.0f + "%", CFG.COLOR_HOVER_TITLE));
