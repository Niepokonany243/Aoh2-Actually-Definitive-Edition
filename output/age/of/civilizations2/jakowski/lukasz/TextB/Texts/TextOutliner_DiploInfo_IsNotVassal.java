...
public class TextOutliner_DiploInfo_IsNotVassal
extends Text {
    ...
    public TextOutliner_DiploInfo_IsNotVassal(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(" " + CFG.lang.get("CivBHasSwornFealtyToCivA") + " ", CFG.COLOR_NEGATIVE_2));
    ...
    public void actionElem(int iID) {
        CFG.toastM.addM((this.iCivLeft >= 0 ? CFG.core.getCiv(this.iCivLeft).getCivName() : CFG.lang.get("Undiscovered")) + " " + CFG.lang.get("CivBHasSwornFealtyToCivA") + " " + (this.iCivRight >= 0 ? CFG.core.getCiv(this.iCivRight).getCivName() : CFG.lang.get("Undiscovered")), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
    }
}
