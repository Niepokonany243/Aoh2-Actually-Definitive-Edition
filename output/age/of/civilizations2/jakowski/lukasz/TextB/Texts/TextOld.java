...
extends MenuElemUI {
    ...
    public TextOld(String sText, int iPosX, int iPosY) {
    ...
    public TextOld(String sText, int iPosX, int iPosY, int fontID) {
        this.typeOfMenuElemUI = MenuElemUI.TypeOfMenuElemUI.TEXT;
        this.fontID = fontID;
        this.setPosX(iPosX);
        this.setPosY(iPosY);
    ...
    public TextOld(String sText, int iTextPositionX, int iPosX, int iPosY, int iHeight) {
        this.typeOfMenuElemUI = MenuElemUI.TypeOfMenuElemUI.TEXT;
    ...
    public TextOld(String sText, int iTextPositionX, int iPosX, int iPosY, int iHeight, float fontID) {
        this.typeOfMenuElemUI = MenuElemUI.TypeOfMenuElemUI.TEXT;
    ...
    public TextOld(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
        this.typeOfMenuElemUI = MenuElemUI.TypeOfMenuElemUI.TEXT;
        this.iTextPositionX = iTextPositionX;
        this.setPosX(iPosX);
        this.setPosY(iPosY);
    ...
    public TextOld(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, int fontID) {
        this.fontID = fontID;
        this.typeOfMenuElemUI = MenuElemUI.TypeOfMenuElemUI.TEXT;
        this.iTextPositionX = iTextPositionX;
        this.setPosX(iPosX);
    ...
    public void updateTextPosition() {
        this.textPosition = this.iTextPositionX < 0 ? new Text.TextPosition(){
            ...
            @Override
            public int getTextPosition() {
                return TextOld.this.getWidthE() / 2 - TextOld.this.iTextWidth / 2;
            }
        } : new Text.TextPosition(){

            @Override
            public int getTextPosition() {
                return TextOld.this.iTextPositionX;
            }
        };
    }
