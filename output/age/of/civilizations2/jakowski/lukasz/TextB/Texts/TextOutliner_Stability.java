...
public class TextOutliner_Stability
extends Text {
    ...
    public TextOutliner_Stability(int nCivID, String researchProgress, int iPosX, int iPosY, int iWidth) {
        ...
        int nIMGID = Images.diploStability;
    ...
    public void drawE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
        ...
        int imgID = Images.diploStability;
