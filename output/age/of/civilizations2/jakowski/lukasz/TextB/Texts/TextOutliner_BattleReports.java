...
public class TextOutliner_BattleReports
extends Text {
    ...
    public TextOutliner_BattleReports(int nCivID, String researchProgress, int iPosX, int iPosY, int iWidth) {
    ...
    public void buildElemHover() {
        ...
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Battles") + ": "));
        nData.add(new ME_Hover_2Type_Text_Big("" + CFG.gameAction.battleReports.size(), CFG.COLOR_HOVER_TITLE));
    ...
    public void setTextE(String sText) {
        ...
        try {
            ...
            this.colorText = CFG.COLOR_TEXT_GRAY_NS;
