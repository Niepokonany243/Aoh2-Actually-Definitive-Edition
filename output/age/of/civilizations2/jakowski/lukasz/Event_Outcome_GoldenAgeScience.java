...
public class Event_Outcome_GoldenAgeScience
extends Event_Outcome {
    ...
    public void outcomeAction() {
        try {
            if (this.canMakeAction()) {
                GameManager.goldenAge_Science(this.getCivID());
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAScience") + ": " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAScience");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text("" + CFG.lang.get("GAScience"), CFG.COLOR_HOVER_TITLE));
                tData.add(new ME_Hover_2Type_Image(Images.diploGoldenAgeS, CFG.PADD, 0));
