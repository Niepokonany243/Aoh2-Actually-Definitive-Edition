...
public class Event_Conditions_IsPartOfHRE
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv(this.getCivID()).getIsPartOfHolyRomanEmpire();
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("IsPartOfHRE") + ": " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("IsPartOfHRE");
        }
    }
