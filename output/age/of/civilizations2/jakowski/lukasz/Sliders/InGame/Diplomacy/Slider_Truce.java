...
extends Slider_BG {
    ...
    public Slider_Truce(int iCivA, int iCivB, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
    ...
    public Slider_Truce(int iCivA, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
        super("", iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
        this.iCivA = iCivA;
    }

    public Slider_Truce(int iCivA, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("Truce") + ": "));
