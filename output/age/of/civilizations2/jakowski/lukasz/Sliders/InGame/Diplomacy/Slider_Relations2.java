...
public class Slider_Relations2
extends Slider_BG_ZeroInMiddle {
    public Slider_Relations2(int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
        super(iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
    }

    public Slider_Relations2(int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
