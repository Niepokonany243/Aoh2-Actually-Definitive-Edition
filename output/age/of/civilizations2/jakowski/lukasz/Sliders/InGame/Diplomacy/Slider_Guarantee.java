...
public class Slider_Guarantee
extends Slider_BG {
    public int iCivA = 0;
    public int iCivB = 0;

    public Slider_Guarantee(int iCivA, int iCivB, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
        super("", iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
        this.iCivA = iCivA;
        this.iCivB = iCivB;
    }

    public Slider_Guarantee(int iCivA, int iCivB, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
        this(iCivA, iCivB, iPosX, iPosY, iWidth, iHeight, (long)iMin, (long)iMax, (long)iCurrent);
    }

    public Slider_Guarantee(int iCivA, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
        super("", iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
        this.iCivA = iCivA;
    }

    public Slider_Guarantee(int iCivA, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
