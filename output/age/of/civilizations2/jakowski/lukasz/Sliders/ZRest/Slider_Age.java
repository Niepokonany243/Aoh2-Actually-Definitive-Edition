...
extends Slider {
    public Slider_Age(int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
    ...
    public Slider_Age(String sText, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
