...
extends Slider_LR {
    public Slider_LR_PercOver(int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
    ...
    public Slider_LR_PercOver(int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
        super("", iPosX, iPosY, iWidth, iHeight, (long)iMin, (long)iMax, (long)iCurrent);
    }

    public Slider_LR_PercOver(String sText, int iPosX, int iPosY, int iWidth, int iHeight, long iMin, long iMax, long iCurrent) {
    ...
    public Slider_LR_PercOver(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
        super(sText, iPosX, iPosY, iWidth, iHeight, (long)iMin, (long)iMax, (long)iCurrent);
    }
