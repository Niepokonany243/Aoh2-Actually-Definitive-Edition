...
public class Event_Outcome_Independence
extends Event_Outcome {
    private static final long serialVersionUID = -5937813429927917469L;
    public int iCivID = -1;
    ...
    public void outcomeAction() {
        if (this.canMakeAction()) {
            CFG.core.setGuarantee(this.getCivID(), this.getCivID2(), (int)this.getValue());
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("ProclaimIndependence") + ": ", CFG.COLOR_HOVER_TITLE));
                ...
                tData.add(new ME_Hover_2Type_Text(GameCalendar.getDate_ByTurnID(GameCalendar.TURNID + (int)this.getValue()), CFG.COLOR_NEUTRAL2));
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("GuaranteeIndependence") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + ", " + CFG.core.getCiv(this.getCivID2()).getCivName() + ": " + this.getValue();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("GuaranteeIndependence");
        }
    }
