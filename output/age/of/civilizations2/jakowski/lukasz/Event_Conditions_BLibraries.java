...
public class Event_Conditions_BLibraries
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv((int)this.getCivID()).numOf_Libraries >= this.getValue();
        }
        catch (Exception ex) {
            return false;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("Buildings") + " " + CFG.lang.get("Library") + " >= " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (Exception ex) {
            return CFG.lang.get("Buildings") + " " + CFG.lang.get("Library");
        }
    }
