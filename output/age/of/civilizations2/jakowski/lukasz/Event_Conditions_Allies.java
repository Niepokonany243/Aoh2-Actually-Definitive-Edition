...
public class Event_Conditions_Allies
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv(this.getCivID()).getAlliance() > 0 && CFG.core.getCiv(this.getCivID()).getAlliance() == CFG.core.getCiv(this.getCivID2()).getAlliance();
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("Allies") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + " - " + CFG.core.getCiv(this.getCivID2()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("Allies");
        }
    }
