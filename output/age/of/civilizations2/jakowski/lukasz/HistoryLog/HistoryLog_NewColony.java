...
public class HistoryLog_NewColony
extends HistoryLog {
    private String sMess;
    private int iMessWidth;
    public int iCivAWidth;

    public HistoryLog_NewColony(int iCivID, int iProvinceID) {
        this.historyLog_Type = HistoryLog_Types.NEW_COONY;
        this.iCivA = iCivID;
    ...
    public void updateLanguage() {
        this.sMess = CFG.lang.get("CityHasBeenFounded", CFG.core.getProv(this.iCivB).getName());
    ...
    public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
        this.drawLeftIcon(oSB, Images.editorCity, iPosX, iPosY, iWidth, iHeight, isActive);
