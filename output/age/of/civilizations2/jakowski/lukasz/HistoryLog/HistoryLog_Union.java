...
extends HistoryLog {
    ...
    public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
        this.drawLeftIcon(oSB, Images.diploUnion, iPosX, iPosY, iWidth, iHeight, isActive);
        ...
        IMGManager.getIMG(Images.pix255).drawO(oSB, iPosX + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID), iPosY + (int)(((float)iHeight - (float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) / 2.0f) - IMGManager.getIMG(Images.pix255).getHeight(), 2, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)));
        oSB.setColor(Color.WHITE);
        CFG.fontMain.get(0).getData().setScale(0.7f);
        try {
            CFG.core.getCiv(this.iCivA).getFlagC().drawO(oSB, iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID), iPosY + (int)(((float)iHeight - (float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) / 2.0f) - CFG.core.getCiv(this.iCivA).getFlagC().getHeight(), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)));
            IMGManager.getIMG(Images.flagRectSmall).drawO(oSB, iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID), iPosY + (int)(((float)iHeight - (float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) / 2.0f) - IMGManager.getIMG(Images.flagRectSmall).getHeight(), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)));
            CFG.drawTextDefault(oSB, CFG.core.getCiv(this.iCivA).getCivName(), iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID) + CFG.PADD + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)), iPosY + (int)(((float)iHeight - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f), CFG.COLOR_TEXT_CIV_NAME);
        }
        catch (IndexOutOfBoundsException ex) {
            IMGManager.getIMG(Images.randomCivilizationFlag).drawO(oSB, iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID), iPosY + (int)(((float)iHeight - (float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) / 2.0f) - IMGManager.getIMG(Images.randomCivilizationFlag).getHeight(), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)));
            IMGManager.getIMG(Images.flagRectSmall).drawO(oSB, iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID), iPosY + (int)(((float)iHeight - (float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) / 2.0f) - IMGManager.getIMG(Images.flagRectSmall).getHeight(), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * HistoryLog_Union.getImageScale(Images.flagRectSmall)));
        }
        CFG.drawTextDefault(oSB, this.sMess, iPosX + 2 + ICON_WIDTH + CFG.PADD + HistoryManager.lHistoryDatesWidth.get(nTurnID) + CFG.PADD + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * HistoryLog_Union.getImageScale(Images.flagRectSmall)) + this.iCivAWidth, iPosY + (int)(((float)iHeight - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.7f) / 2.0f), CFG.COLOR_TEXT_RANK);
