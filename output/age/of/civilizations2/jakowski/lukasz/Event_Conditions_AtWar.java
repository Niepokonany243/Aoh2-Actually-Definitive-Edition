...
public class Event_Conditions_AtWar
extends Event_Conditions {
    private static final long serialVersionUID = 9133369440309203390L;
    public int iCivID = -1;
    ...
    public boolean outCondition() {
        try {
            return (int)CFG.core.getCivRelationOfCivB(this.getCivID(), this.getCivID2()) == GameValues.gvDiplomacy.RELATION_AT_WAR;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("AtWar") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + " - " + CFG.core.getCiv(this.getCivID2()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("AtWar");
        }
    }
