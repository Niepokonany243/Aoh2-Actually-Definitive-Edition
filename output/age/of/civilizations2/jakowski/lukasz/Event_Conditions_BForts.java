...
public class Event_Conditions_BForts
extends Event_Conditions {
    ...
    public boolean outCondition() {
        try {
            return CFG.core.getCiv((int)this.getCivID()).numOf_Forts >= this.getValue();
        }
        catch (Exception ex) {
            return false;
        }
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("Buildings") + " " + CFG.lang.get("Fort") + " >= " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (Exception ex) {
            return CFG.lang.get("Buildings") + " " + CFG.lang.get("Fort");
        }
    }
