...
public class Event_Conditions_NumOfUnits
extends Event_Conditions {
    private static final long serialVersionUID = -5888024215993630897L;
    public int iCivID = -1;
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("NumberOfUnits") + " >= " + this.getValue() + ", " + CFG.core.getCiv(this.getCivID()).getCivName();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("NumberOfUnits");
        }
    }
