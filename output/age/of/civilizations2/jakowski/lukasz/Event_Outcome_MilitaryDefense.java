...
public class Event_Outcome_MilitaryDefense
extends Event_Outcome {
    ...
    public void outcomeAction() {
        if (this.canMakeAction()) {
            CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseLevel = Math.max(0, (int)(CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseLevel + this.getValue()));
            CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseDefense = Math.max(0, (int)(CFG.core.getCiv((int)this.getCivID()).civGD.armyExpertiseDefense + this.getValue()));
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Defense") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + ", " + (this.getValue() > 0 ? "+" : "") + this.getValue();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Defense");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Defense") + ": "));
                ...
                tData.add(new ME_Hover_2Type_Image(Images.defense, CFG.PADD, 0));
                tData.add(new ME_Hover_2Type_Image(Images.diploArmyStar, CFG.PADD, 0));
