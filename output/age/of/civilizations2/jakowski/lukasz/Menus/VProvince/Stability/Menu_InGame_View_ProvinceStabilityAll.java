...
public class Menu_InGame_View_ProvinceStabilityAll
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;

    public Menu_InGame_View_ProvinceStabilityAll() {
        ...
        for (int i = 1; i < CFG.core.getCivsSize(); ++i) {
            ...
            tCivs.add(i);
            totalStability += CFG.core.getCiv((int)i).fStability;
        }
        if (!tCivs.isEmpty()) {
            totalStability /= (float)tCivs.size();
        }
        menuElements.add(new Button_DiplomacyAction(Images.diploStability, CFG.lang.get("Stability") + ": " + CFG.getPrecision2(Math.min(100.0f, totalStability * 100.0f), 100) + "%", 0, 0, tY, tempW, Menu_InGame_Civ_Decisions.getButtonH(), true){
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Average") + ", "));
        ...
        if (!tCivs.isEmpty()) {
            ...
            while (!tCivs.isEmpty()) {
                ...
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (!(CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fStability < CFG.core.getCiv((int)((Integer)tCivs.get((int)o)).intValue()).fStability)) continue;
                    toAddID = o;
                }
                ...
                menuElements.add(new ButtonN_Pop2(new Color((float)CFG.core.getCiv(civID).getR() / 255.0f, (float)CFG.core.getCiv(civID).getG() / 255.0f, (float)CFG.core.getCiv(civID).getB() / 255.0f, 1.0f), rankID++ + ". " + (metCiv ? CFG.core.getCiv(civID).getCivName() : CFG.lang.get("Undiscovered")), metCiv ? civID : -1, "" + CFG.getPrecision2(Math.min(100.0f, CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fStability / totalStability * 100.0f), 100) + "%", CFG.getPrecision2(Math.min(100.0f, CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fStability * 100.0f), 100) + "%", Images.diploStability, CFG.getColorStep(CFG.COLOR_PROVINCE_STABILITY_MIN, CFG.COLOR_PROVINCE_STABILITY_MAX, (int)(CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fStability * 100.0f), 100, 1.0f), 0, tY, tempW){
                    ...
                    public void buildElemHover() {
                        try {
                            ...
                            if (this.iCivID > 0) {
                                ...
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("Stability") + ": "));
                                nData.add(new ME_Hover_2Type_Text(CFG.getPrecision2(CFG.core.getCiv((int)this.iCivID).fStability * 100.0f, 100) + "%", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        this.initMenu(new TitleM_TextSmall(CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()) + ": " + CFG.lang.get("Stability") + (playerRankID > 0 ? " #" + playerRankID : ""), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_ProvinceStabilityAll.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_ProvinceStabilityAll.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_ProvinceStabilityAll.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_ProvinceStabilityAll.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_ProvinceStabilityAll.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_ProvinceStabilityAll.this.getPosX() + Menu_InGame_View_ProvinceStabilityAll.this.getWidthM() - Menu_InGame_View_ProvinceStabilityAll.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_ProvinceStabilityAll.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.diploStability).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_ProvinceStabilityAll.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.diploStability).getHeight() / 2);
