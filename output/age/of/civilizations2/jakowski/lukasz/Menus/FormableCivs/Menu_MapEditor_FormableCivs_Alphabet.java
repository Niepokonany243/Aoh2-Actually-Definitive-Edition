...
public class Menu_MapEditor_FormableCivs_Alphabet
extends Menu {
    private List<Character> lCharacters;
    private String nSearch = null;

    public Menu_MapEditor_FormableCivs_Alphabet() {
        ...
        menuElements.add(new Button_Classic_Classic_Search("", CFG.PADD * 2, 0, CFG.PADD, CFG.BUTTON_W * 2, CFG.BUTTON_H, true){
            ...
            public String getTextToDrawElem() {
                return Menu_MapEditor_FormableCivs_Alphabet.this.nSearch + ": " + super.getTextToDrawElem();
            }
        });
        ...
        try {
            ...
            for (i = 0; i < iSize; ++i) {
                ...
                if (CFG.lang.getCiv(tagsSPLITED[i]).length() <= 0) continue;
