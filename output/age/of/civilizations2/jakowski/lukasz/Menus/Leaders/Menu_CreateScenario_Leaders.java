...
public class Menu_CreateScenario_Leaders
extends Menu {
    public static View backTo = View.eCREATE_SCENARIO_EVENTS_OUT_LEADER;

    public Menu_CreateScenario_Leaders() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Leaders"));
    }
