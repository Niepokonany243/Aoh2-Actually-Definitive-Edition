...
public class Menu_InGame_View_BSupply
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;
    private int iCivID = 0;

    public Menu_InGame_View_BSupply() {
        ...
        if (this.iCivID != CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()) {
            ...
            for (int i = 1; i < CFG.core.getCivsSize(); ++i) {
                ...
                for (a = 0; a < CFG.core.getCiv(i).getNumOfProvs(); ++a) {
                    tTotal += CFG.core.getProv(CFG.core.getCiv(i).getProvID(a)).getLvlOfSupply();
                }
                worldTotal += tTotal;
                tCivs.add(i);
                tNum.add(tTotal);
            ...
            for (int i = 0; i < CFG.core.getCiv(this.iCivID).getNumOfProvs(); ++i) {
                ...
                if (CFG.core.getProv(CFG.core.getCiv(this.iCivID).getProvID(i)).getLvlOfSupply() <= 0) continue;
                buildingsTotal += CFG.core.getProv(CFG.core.getCiv(this.iCivID).getProvID(i)).getLvlOfSupply();
            }
            ...
            if (!tempProvincesSorted.isEmpty()) {
                ...
                menuElements.add(new Button_Icon(nX += nW, tY, tempW - nX, buttonH, Images.bArmoury){
                ...
                for (int i = tempProvincesSorted.size() - 1; i >= 0; --i) {
                    ...
                    menuElements.add(new Button_Build2(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getProvName(), Images.bSupply, BuildingsManager.getSupply_BuildCost(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfSupply() + 1, (Integer)tempProvincesSorted.get(i)), BuildingsManager.getSupply_BuildMovementCost(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfSupply() + 1), 0, tY, tempW + (investButton ? -extraW : 0), true, CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfSupply() == BuildingsManager.getSupply_MaxLevel(), CFG.core.getCiv(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getCivId()).isInConstruction((Integer)tempProvincesSorted.get(i), ConstructionType.SUPPLY), BuildingsManager.getSupply_TechLevel(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfSupply() + 1), (Integer)tempProvincesSorted.get(i)){

                        @Override
                        public void actionElem(int iID) {
                            if (CFG.core.getProv(this.getCurr()).getLvlOfSupply() == BuildingsManager.getSupply_MaxLevel()) {
                                CFG.toastM.addM(CFG.lang.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                            } else if (CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.SUPPLY) > 0) {
                                CFG.toastM.addM(CFG.lang.get("InConstruction"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                            } else {
                                CFG.menus.rebuildInGame_BuildSupply(this.getCurr());
                            }
                        }

                        @Override
                        public void actionElemPPM() {
                            Menu_InGame_View_BSupply.build(this.getCurr());
                        }
                        ...
                        public void buildElemHover() {
                            ...
                            ArrayList<ME_Hover_2Type> nData = new ArrayList<ME_Hover_2Type>();
                            if (CFG.core.getProv(this.getCurr()).getLvlOfSupply() == BuildingsManager.getSupply_MaxLevel()) {
                                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get(BuildingsManager.getSupply_Name(CFG.core.getProv(this.getCurr()).getLvlOfSupply())) + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                                ...
                                nData.add(new ME_Hover_2Type_Text("-" + (int)(BuildingsManager.getSupply_Bonus(CFG.core.getProv(this.getCurr()).getLvlOfSupply()) * 100.0f) + "%", CFG.COLOR_POSITIVE));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                            } else if (CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.SUPPLY) > 0) {
                                ...
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(GameCalendar.getDate_ByTurnID(GameCalendar.TURNID + CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.SUPPLY))));
                                nData.add(new ME_Hover_2Type_Text(" [" + CFG.lang.get("TurnsX", CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.SUPPLY)) + "]", CFG.COLOR_NEUTRAL));
                                ...
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get(BuildingsManager.getSupply_Name(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1)) + ": ", CFG.COLOR_HOVER_TITLE));
                                ...
                                nData.add(new ME_Hover_2Type_Text(" - "));
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("MilitaryUpkeep") + ": "));
                                nData.add(new ME_Hover_2Type_Text("-" + (int)(BuildingsManager.getSupply_Bonus(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) * 100.0f) + "%", CFG.COLOR_POSITIVE));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Space());
                                nElements.add(new MEHover_2E(nData));
                                ...
                                nData.add(new ME_Hover_2Type_Text("" + BuildingsManager.getSupply_BuildCost(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1, this.getCurr()), CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getGold() >= (long)BuildingsManager.getSupply_BuildCost(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1, this.getCurr()) ? CFG.COLOR_GOLD : CFG.COLOR_NEGATIVE_2));
                                ...
                                nData.add(new ME_Hover_2Type_Text("" + (float)BuildingsManager.getSupply_BuildMovementCost(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) / 10.0f, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getMovemPoints() >= BuildingsManager.getSupply_BuildMovementCost(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) ? CFG.COLOR_MOVEMENT : CFG.COLOR_NEGATIVE_2));
                                nData.add(new ME_Hover_2Type_Image(Images.topMovementPoints, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ConstructionWillTakeXurns", BuildingsManager.getSupply_Construction(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1))));
                                nData.add(new ME_Hover_2Type_Image(Images.time, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("RequiredTechnologyLevel") + ": "));
                                nData.add(new ME_Hover_2Type_Text("" + (float)((int)(BuildingsManager.getSupply_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) * 100.0f)) / 100.0f, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getTechLevel() >= BuildingsManager.getSupply_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) ? CFG.COLOR_TECHNOLOGY : CFG.COLOR_NEGATIVE_2));
                                nData.add(new ME_Hover_2Type_Image(Images.technology, CFG.PADD, 0));
                                nData.add(new ME_Hover_2Type_Image(CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getTechLevel() >= BuildingsManager.getSupply_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfSupply() + 1) ? Images.iconTrue : Images.iconFalse, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                            }
                            this.menuElemHover = new ME_Hover_v2(nElements);
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("SupplyCamp") + (worldTotal > 0 ? " [" + CFG.getNumberWthSpaces("" + worldTotal) + "]" : ""), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_BSupply.this.getPosX() + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_BSupply.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_BSupply.this.getPosX() + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_BSupply.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_BSupply.this.getPosX() + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_BSupply.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_BSupply.this.getPosX() + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_BSupply.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_BSupply.this.getPosX() + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_BSupply.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_BSupply.this.getPosX() + Menu_InGame_View_BSupply.this.getWidthM() - Menu_InGame_View_BSupply.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_BSupply.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.bSupply).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_BSupply.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.bSupply).getHeight() / 2);
    ...
    public static void build(int provinceID) {
        if (CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getGold() < (long)BuildingsManager.getSupply_BuildCost(CFG.core.getProv(provinceID).getLvlOfSupply() + 1, provinceID)) {
            CFG.toastM.addM(CFG.lang.get("InsufficientGold") + ": " + CFG.getNumberWthSpaces("" + BuildingsManager.getSupply_BuildCost(CFG.core.getProv(provinceID).getLvlOfSupply() + 1, provinceID)), CFG.COLOR_NEGATIVE_2);
            CFG.toastM.setTimeInView(3500);
        } else if (CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getMovemPoints() < BuildingsManager.getSupply_BuildMovementCost(CFG.core.getProv(provinceID).getLvlOfSupply() + 1)) {
            CFG.toastM.addM(CFG.lang.get("MovementPoints") + ": " + (float)BuildingsManager.getSupply_BuildMovementCost(CFG.core.getProv(provinceID).getLvlOfSupply() + 1) / 10.0f, CFG.COLOR_NEGATIVE_2);
            CFG.toastM.setTimeInView(3500);
        }
        if (BuildingsManager.constructSupply(provinceID, CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId())) {
            ...
            if (CFG.mapModesManager.getActiveMapModeID() == MapModesManager.VIEW_LEVEL_OF_SUPPLY_MODE) {
