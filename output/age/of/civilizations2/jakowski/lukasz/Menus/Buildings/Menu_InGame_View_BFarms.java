...
public class Menu_InGame_View_BFarms
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;
    private int iCivID = 0;

    public Menu_InGame_View_BFarms() {
        ...
        if (this.iCivID != CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()) {
            ...
            for (int i = 1; i < CFG.core.getCivsSize(); ++i) {
                ...
                for (a = 0; a < CFG.core.getCiv(i).getNumOfProvs(); ++a) {
                    tTotal += CFG.core.getProv(CFG.core.getCiv(i).getProvID(a)).getLvlOfFarm();
                }
                worldTotal += tTotal;
                tCivs.add(i);
                tNum.add(tTotal);
            ...
            for (int i = 0; i < CFG.core.getCiv(this.iCivID).getNumOfProvs(); ++i) {
                ...
                if (CFG.core.getProv(CFG.core.getCiv(this.iCivID).getProvID(i)).getLvlOfFarm() <= 0) continue;
                buildingsTotal += CFG.core.getProv(CFG.core.getCiv(this.iCivID).getProvID(i)).getLvlOfFarm();
            }
            ...
            if (!tempProvincesSorted.isEmpty()) {
                ...
                for (int i = tempProvincesSorted.size() - 1; i >= 0; --i) {
                    ...
                    menuElements.add(new Button_Build_Level2(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getProvName(), Images.bFarm, "" + CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfFarm(), BuildingsManager.getFarm_BuildCost(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfFarm() + 1, (Integer)tempProvincesSorted.get(i)), BuildingsManager.getFarm_BuildMovementCost(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfFarm() + 1), 0, tY, tempW + (investButton ? -extraW : 0), true, CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfFarm() == BuildingsManager.getFarm_MaxLevel(), CFG.core.getCiv(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getCivId()).isInConstruction((Integer)tempProvincesSorted.get(i), ConstructionType.FARM), BuildingsManager.getFarm_TechLevel(CFG.core.getProv((Integer)tempProvincesSorted.get(i)).getLvlOfFarm() + 1), (Integer)tempProvincesSorted.get(i)){

                        @Override
                        public void actionElem(int iID) {
                            if (CFG.core.getProv(this.getCurr()).getLvlOfFarm() == BuildingsManager.getFarm_MaxLevel()) {
                                CFG.toastM.addM(CFG.lang.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                            } else if (CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.FARM) > 0) {
                        ...
                        @Override
                        public void actionElemPPM() {
                            Menu_InGame_View_BFarms.build(this.getCurr());
                        }
                        ...
                        public void buildElemHover() {
                            ...
                            if (CFG.core.getProv(this.getCurr()).getLvlOfFarm() == BuildingsManager.getFarm_MaxLevel()) {
                                ...
                                nData.add(new ME_Hover_2Type_Text("+" + (int)(BuildingsManager.getFarm_GrowthRateBonus(CFG.core.getProv(this.getCurr()).getLvlOfFarm()) * 100.0f) + "%", CFG.COLOR_POSITIVE));
                                ...
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(GameCalendar.getDate_ByTurnID(GameCalendar.TURNID + CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.FARM))));
                                nData.add(new ME_Hover_2Type_Text(" [" + CFG.lang.get("TurnsX", CFG.core.getCiv(CFG.core.getProv(this.getCurr()).getCivId()).isInConstruction(this.getCurr(), ConstructionType.FARM)) + "]", CFG.COLOR_NEUTRAL));
                                ...
                                nData.add(new ME_Hover_2Type_Text(" - "));
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("GrowthRate") + ": "));
                                nData.add(new ME_Hover_2Type_Text("+" + (int)(BuildingsManager.getFarm_GrowthRateBonus(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) * 100.0f) + "%", CFG.COLOR_POSITIVE));
                                nData.add(new ME_Hover_2Type_Image(Images.popGrowth, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Space());
                                ...
                                nData.add(new ME_Hover_2Type_Text("" + BuildingsManager.getFarm_BuildCost(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1, this.getCurr()), CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getGold() >= (long)BuildingsManager.getFarm_BuildCost(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1, this.getCurr()) ? CFG.COLOR_GOLD : CFG.COLOR_NEGATIVE_2));
                                ...
                                nData.add(new ME_Hover_2Type_Text("" + (float)BuildingsManager.getFarm_BuildMovementCost(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) / 10.0f, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getMovemPoints() >= BuildingsManager.getFarm_BuildMovementCost(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) ? CFG.COLOR_MOVEMENT : CFG.COLOR_NEGATIVE_2));
                                nData.add(new ME_Hover_2Type_Image(Images.topMovementPoints, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ConstructionWillTakeXurns", BuildingsManager.getFarm_Construction(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1))));
                                nData.add(new ME_Hover_2Type_Image(Images.time, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("RequiredTechnologyLevel") + ": "));
                                nData.add(new ME_Hover_2Type_Text("" + (float)((int)(BuildingsManager.getFarm_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) * 100.0f)) / 100.0f, CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getTechLevel() >= BuildingsManager.getFarm_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) ? CFG.COLOR_TECHNOLOGY : CFG.COLOR_NEGATIVE_2));
                                nData.add(new ME_Hover_2Type_Image(Images.technology, CFG.PADD, 0));
                                nData.add(new ME_Hover_2Type_Image(CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getTechLevel() >= BuildingsManager.getFarm_TechLevel(CFG.core.getProv(this.getCurr()).getLvlOfFarm() + 1) ? Images.iconTrue : Images.iconFalse, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                            }
                            this.menuElemHover = new ME_Hover_v2(nElements);
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("Farm") + (worldTotal > 0 ? " [" + CFG.getNumberWthSpaces("" + worldTotal) + "]" : ""), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_BFarms.this.getPosX() + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_BFarms.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                oSB.setColor(new Color(0.23529412f, 0.7019608f, 0.44313726f, 0.165f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, nPosX + iTranslateX, nPosY - this.getHeightT() + 2 - IMGManager.getIMG(Images.line32Off1).getHeight(), nWidth, this.getHeightT() - 2, false, true);
                oSB.setColor(new Color(0.23529412f, 0.7019608f, 0.44313726f, 0.375f));
                IMGManager.getIMG(Images.gradient).drawO(oSB, nPosX + iTranslateX, nPosY - this.getHeightT() * 2 / 3 - IMGManager.getIMG(Images.gradient).getHeight(), nWidth, this.getHeightT() * 2 / 3, false, true);
                oSB.setColor(CFG.COLOR_NEW_GAME_EDGE_LINE);
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_BFarms.this.getPosX() + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_BFarms.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_BFarms.this.getPosX() + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_BFarms.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_BFarms.this.getPosX() + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_BFarms.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_BFarms.this.getPosX() + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_BFarms.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_BFarms.this.getPosX() + Menu_InGame_View_BFarms.this.getWidthM() - Menu_InGame_View_BFarms.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_BFarms.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.bFarm).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_BFarms.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.bFarm).getHeight() / 2);
    ...
    public static void build(int provinceID) {
        if (CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getGold() < (long)BuildingsManager.getFarm_BuildCost(CFG.core.getProv(provinceID).getLvlOfFarm() + 1, provinceID)) {
            CFG.toastM.addM(CFG.lang.get("InsufficientGold") + ": " + CFG.getNumberWthSpaces("" + BuildingsManager.getFarm_BuildCost(CFG.core.getProv(provinceID).getLvlOfFarm() + 1, provinceID)), CFG.COLOR_NEGATIVE_2);
            CFG.toastM.setTimeInView(3500);
        } else if (CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getMovemPoints() < BuildingsManager.getFarm_BuildMovementCost(CFG.core.getProv(provinceID).getLvlOfFarm() + 1)) {
            CFG.toastM.addM(CFG.lang.get("MovementPoints") + ": " + (float)BuildingsManager.getFarm_BuildMovementCost(CFG.core.getProv(provinceID).getLvlOfFarm() + 1) / 10.0f, CFG.COLOR_NEGATIVE_2);
            CFG.toastM.setTimeInView(3500);
        }
        if (BuildingsManager.constructFarm(provinceID, CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId())) {
            ...
            if (CFG.mapModesManager.getActiveMapModeID() == MapModesManager.VIEW_LEVEL_OF_FARM_MODE) {
                CFG.core.getProv((int)provinceID).viewBool = true;
                if (CFG.menus.getVisible_InGame_View_Stats()) {
