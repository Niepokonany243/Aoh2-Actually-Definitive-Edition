...
public class Menu_InGame_LeaveAlliance
extends Menu {
    public Menu_InGame_LeaveAlliance(int onCivID) {
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_CallToArms(Images.diploAlliance, CFG.lang.get("LeaveAlliance"), CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId(), 2, tY, CFG.BUTTON_W * 2, GameValues.gvAllianceOffer.COST_ALLIANCE_LEAVE){

            @Override
            public int getWidthE() {
                return Menu_InGame_LeaveAlliance.this.getElementW() * 2;
            }

            @Override
            public void actionElem(int iID) {
                CFG.menus.rebuildInGame_Alliance(CFG.core.getCiv(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()).getAlliance());
            }
        });
        ...
        menuElements.add(new Button_InGameAction(CFG.lang.get("Cancel"), -1, 2 + CFG.PADD, tY += CFG.PADD, CFG.BUTTON_W, true){
            ...
            @Override
            public int getWidthE() {
                return Menu_InGame_LeaveAlliance.this.getElementW() - CFG.PADD - CFG.PADD / 2;
            }
        });
        menuElements.add(new Button_InGameAction(CFG.lang.get("Confirm"), -1, 2, tY, CFG.BUTTON_W, true){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_LeaveAlliance.this.getElementW() + CFG.PADD / 2;
            }
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("LeaveAlliance"), CFG.COLOR_HOVER_TITLE));
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("LeaveAlliance"), CFG.BUTTON_H * 3 / 4, true, true){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                IMGManager.getIMG(imgID).drawO(oSB, nPosX + (nWidth - (this.getTextWidth() + IMGManager.getIMG(imgID).getWidth() + CFG.PADD)) / 2 + iTranslateX, Menu_InGame_LeaveAlliance.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(imgID).getHeight() / 2);
    ...
    public final void actionEL(int iID) {
        if (iID == this.getMenuElemsSize() - 1) {
            GameManager.leaveAlliance(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId());
