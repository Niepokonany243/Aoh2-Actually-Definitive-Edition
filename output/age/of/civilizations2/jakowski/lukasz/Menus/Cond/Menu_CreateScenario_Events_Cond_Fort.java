...
public class Menu_CreateScenario_Events_Cond_Fort
extends Menu {
    public Menu_CreateScenario_Events_Cond_Fort() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Fort"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_PROVINCES_FORT;
