...
public class Menu_CreateScenario_Events_Cond_Ideology
extends Menu {
    public Menu_CreateScenario_Events_Cond_Ideology() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(5).setTextE(CFG.lang.get("Government") + ": " + (CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getValue() >= 0 ? CFG.ideologiesMgr.getIdeologyID((int)CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getValue()).getName() : ""));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(5).setTextE(CFG.lang.get("Government") + ": ");
        }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_IDEOLOGY;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTIDEOLOGY_COND_IDEOLOGY;
