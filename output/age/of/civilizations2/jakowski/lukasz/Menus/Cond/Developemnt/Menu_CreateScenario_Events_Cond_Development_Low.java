...
public class Menu_CreateScenario_Events_Cond_Development_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_Development_Low() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_PROVINCES_DEVELOPMENT_LOW;
