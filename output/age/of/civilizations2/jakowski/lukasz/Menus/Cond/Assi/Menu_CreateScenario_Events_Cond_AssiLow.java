 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Assi;
...
public class Menu_CreateScenario_Events_Cond_AssiLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_AssiLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("TotalAssimilationCount") + " < ");
        this.getTitleM().setText(CFG.lang.get("TotalAssimilationCount"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ASSILOW;
