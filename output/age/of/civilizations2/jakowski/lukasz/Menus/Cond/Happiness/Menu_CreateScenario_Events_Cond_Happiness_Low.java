...
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Happiness;
...
public class Menu_CreateScenario_Events_Cond_Happiness_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_Happiness_Low() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Happiness") + " < ");
        this.getTitleM().setText(CFG.lang.get("Happiness"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_HAPPINESS_LOW;
