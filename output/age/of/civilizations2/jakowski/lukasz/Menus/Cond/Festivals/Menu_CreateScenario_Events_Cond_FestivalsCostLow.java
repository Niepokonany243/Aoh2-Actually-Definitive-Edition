...
public class Menu_CreateScenario_Events_Cond_FestivalsCostLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_FestivalsCostLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Festivals") + " " + CFG.lang.get("TotalCost") + " < ");
        this.getTitleM().setText(CFG.lang.get("Festivals") + " " + CFG.lang.get("TotalCost"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_FESTIVALSCOSTLOW;
