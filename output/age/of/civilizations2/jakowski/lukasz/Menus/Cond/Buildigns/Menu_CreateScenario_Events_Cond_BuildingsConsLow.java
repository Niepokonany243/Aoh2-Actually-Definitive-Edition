...
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Buildigns;
...
public class Menu_CreateScenario_Events_Cond_BuildingsConsLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_BuildingsConsLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("BuildingConstructed") + " < ");
        this.getTitleM().setText(CFG.lang.get("BuildingConstructed"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_BUILDINGSCONSLOW;
