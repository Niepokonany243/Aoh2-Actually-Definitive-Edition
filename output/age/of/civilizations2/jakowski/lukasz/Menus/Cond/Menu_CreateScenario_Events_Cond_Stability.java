...
public class Menu_CreateScenario_Events_Cond_Stability
extends Menu {
    public Menu_CreateScenario_Events_Cond_Stability() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_STABILITY;
