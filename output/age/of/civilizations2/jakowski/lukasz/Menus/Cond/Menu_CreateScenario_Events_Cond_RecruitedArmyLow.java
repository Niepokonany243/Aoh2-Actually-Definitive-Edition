...
public class Menu_CreateScenario_Events_Cond_RecruitedArmyLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_RecruitedArmyLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("RecruitedArmy") + " < ");
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_RECRUITEDARMYLOW;
