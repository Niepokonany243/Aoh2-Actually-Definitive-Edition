...
public class Menu_CreateScenario_Events_Cond_StabilityLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_StabilityLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Stability") + " < ");
        this.getTitleM().setText(CFG.lang.get("Stability"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_STABILITYLOW;
