...
public class Menu_CreateScenario_Events_Cond_Leader
extends Menu {
    public Menu_CreateScenario_Events_Cond_Leader() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(5).setTextE(CFG.lang.get("Leader") + ": " + CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getText());
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(5).setTextE(CFG.lang.get("Leader") + ": ");
        }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_LEADER_COND;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_LEADER_COND_SELECT;
                Menu_CreateScenario_Leaders.backTo = View.eCREATE_SCENARIO_EVENTS_COND_LEADER;
