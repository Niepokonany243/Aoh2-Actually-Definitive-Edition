...
public class Menu_CreateScenario_Events_Cond_BLibraries
extends Menu {
    public Menu_CreateScenario_Events_Cond_BLibraries() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Buildings") + " " + CFG.lang.get("Library") + " >= ");
        this.getTitleM().setText(CFG.lang.get("Buildings") + " " + CFG.lang.get("Library"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_BLIBRARIES;
