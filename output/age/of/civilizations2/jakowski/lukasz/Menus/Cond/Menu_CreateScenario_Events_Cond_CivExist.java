...
public class Menu_CreateScenario_Events_Cond_CivExist
extends Menu {
    public Menu_CreateScenario_Events_Cond_CivExist() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("CivilizationExist"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_COND_CIV_EXIST;
