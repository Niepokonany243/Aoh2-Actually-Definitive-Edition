...
public class Menu_CreateScenario_Events_Cond_NumOfNeighbors
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfNeighbors() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFNEIGHBORS;
