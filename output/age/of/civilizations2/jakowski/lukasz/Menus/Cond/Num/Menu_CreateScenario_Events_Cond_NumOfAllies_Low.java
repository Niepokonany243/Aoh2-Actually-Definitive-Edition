...
public class Menu_CreateScenario_Events_Cond_NumOfAllies_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfAllies_Low() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("NumberOfAllies") + " < ");
        this.getTitleM().setText(CFG.lang.get("NumberOfAllies"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFALLIES_LOW;
