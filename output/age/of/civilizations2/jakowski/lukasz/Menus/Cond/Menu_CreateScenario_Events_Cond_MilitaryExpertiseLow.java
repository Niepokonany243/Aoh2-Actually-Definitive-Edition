...
public class Menu_CreateScenario_Events_Cond_MilitaryExpertiseLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_MilitaryExpertiseLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("MilitaryExpertise") + " < ");
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_MILITARYEXPRERTISELOW;
