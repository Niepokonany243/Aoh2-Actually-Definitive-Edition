 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Treasury;
...
public class Menu_CreateScenario_Events_Cond_Treasury_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_Treasury_Low() {
        ...
        menuElements.add(new Slider_BG(0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD * 2, CFG.GAMEWIDTH, CFG.BUTTON_H - CFG.PADD * 2, -500, 10000, CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getValue() / 100){

            @Override
            public String getDrawText() {
                return this.getTextE() + this.getCurr() * 100;
            }
        });
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Treasury") + " < ");
        this.getTitleM().setText(CFG.lang.get("Treasury"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_TREASURY_LOW;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).setValue(this.getMenuElem(iID).getCurr() * 100);
            }
        }
    }
