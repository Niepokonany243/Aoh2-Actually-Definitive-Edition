...
public class Menu_CreateScenario_Events_Cond_InvestsDevCostLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_InvestsDevCostLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("DevelopmentInvestments") + " " + CFG.lang.get("TotalCost") + " < ");
        this.getTitleM().setText(CFG.lang.get("DevelopmentInvestments") + " " + CFG.lang.get("TotalCost"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_INVESTSDEVCOSTLOW;
