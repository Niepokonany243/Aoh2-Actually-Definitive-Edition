...
public class Menu_CreateScenario_Events_Cond_AveDevLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_AveDevLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("AverageDevelopment") + " < ");
        this.getTitleM().setText(CFG.lang.get("AverageDevelopment"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_AVEDEVLOW;
