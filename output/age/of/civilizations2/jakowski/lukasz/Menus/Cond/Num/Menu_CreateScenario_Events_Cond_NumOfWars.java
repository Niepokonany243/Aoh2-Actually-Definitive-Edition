...
public class Menu_CreateScenario_Events_Cond_NumOfWars
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfWars() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFWARS;
