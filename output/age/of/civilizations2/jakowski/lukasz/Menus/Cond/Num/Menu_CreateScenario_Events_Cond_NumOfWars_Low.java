...
public class Menu_CreateScenario_Events_Cond_NumOfWars_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfWars_Low() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("NumberOfWars") + " < ");
        this.getTitleM().setText(CFG.lang.get("NumberOfWars"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFWARS_LOW;
