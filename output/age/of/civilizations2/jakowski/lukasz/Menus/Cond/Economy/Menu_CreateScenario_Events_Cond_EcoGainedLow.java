...
public class Menu_CreateScenario_Events_Cond_EcoGainedLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_EcoGainedLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("TotalEconomicIncrease") + " < ");
        this.getTitleM().setText(CFG.lang.get("TotalEconomicIncrease"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ECO_GAINEDLOW;
