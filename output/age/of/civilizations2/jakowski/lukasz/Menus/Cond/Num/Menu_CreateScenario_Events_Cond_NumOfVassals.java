...
public class Menu_CreateScenario_Events_Cond_NumOfVassals
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfVassals() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFVASSALS;
