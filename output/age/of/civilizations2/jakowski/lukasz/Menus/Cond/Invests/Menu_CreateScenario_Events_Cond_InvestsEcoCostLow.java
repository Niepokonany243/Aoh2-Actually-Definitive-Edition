...
public class Menu_CreateScenario_Events_Cond_InvestsEcoCostLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_InvestsEcoCostLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Investments") + " " + CFG.lang.get("Economy") + " " + CFG.lang.get("TotalCost") + " < ");
        this.getTitleM().setText(CFG.lang.get("Investments") + " " + CFG.lang.get("Economy") + " " + CFG.lang.get("TotalCost"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_INVESTSCOSTLOW;
