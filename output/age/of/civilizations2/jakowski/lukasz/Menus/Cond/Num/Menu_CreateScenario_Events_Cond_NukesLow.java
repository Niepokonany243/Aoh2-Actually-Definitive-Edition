...
public class Menu_CreateScenario_Events_Cond_NukesLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_NukesLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("AtomicBombs") + " < ");
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUKES;
