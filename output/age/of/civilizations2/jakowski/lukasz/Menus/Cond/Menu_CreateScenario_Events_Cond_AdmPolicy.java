...
public class Menu_CreateScenario_Events_Cond_AdmPolicy
extends Menu {
    public Menu_CreateScenario_Events_Cond_AdmPolicy() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(5).setTextE(CFG.lang.get("AdministrationPolicy") + " == " + CFG.lang.get(GameValues.gvAdministrationPolicy.POLICY_NAME[(int)CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getValue()]));
        }
        catch (Exception ex) {
            this.getMenuElem(5).setTextE(CFG.lang.get("AdministrationPolicy"));
        }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_COND_ADM_POLICY;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_COND_ADM_POLICYLIST);
            }
        }
    }
