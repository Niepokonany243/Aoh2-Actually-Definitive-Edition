...
public class Menu_CreateScenario_Events_Cond_Wasteland
extends Menu {
    public Menu_CreateScenario_Events_Cond_Wasteland() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("IsWasteland"));
        this.getTitleM().setText(CFG.lang.get("IsWasteland"));
    }
