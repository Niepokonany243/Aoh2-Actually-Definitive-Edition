...
public class Menu_CreateScenario_Events_Cond_Allies
extends Menu {
    public Menu_CreateScenario_Events_Cond_Allies() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Allies"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ALLIES;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ALLIES2;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
            }
        }
    }
