...
public class Menu_CreateScenario_Events_Cond_Neutral
extends Menu {
    public Menu_CreateScenario_Events_Cond_Neutral() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("NeutralProvince"));
        this.getTitleM().setText(CFG.lang.get("NeutralProvince"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_PROVINCES_NEUTRAL;
