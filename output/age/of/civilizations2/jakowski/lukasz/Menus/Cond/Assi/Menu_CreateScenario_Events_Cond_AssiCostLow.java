...
public class Menu_CreateScenario_Events_Cond_AssiCostLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_AssiCostLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("TotalAssimilationCost") + " < ");
        this.getTitleM().setText(CFG.lang.get("TotalAssimilationCost"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ASSICOSTLOW;
