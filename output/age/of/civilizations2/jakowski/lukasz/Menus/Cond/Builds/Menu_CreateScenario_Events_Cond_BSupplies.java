 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Builds;
...
public class Menu_CreateScenario_Events_Cond_BSupplies
extends Menu {
    public Menu_CreateScenario_Events_Cond_BSupplies() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Buildings") + " " + CFG.lang.get("SupplyCamp") + " >= ");
        this.getTitleM().setText(CFG.lang.get("Buildings") + " " + CFG.lang.get("SupplyCamp"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_BSUPPLIES;
