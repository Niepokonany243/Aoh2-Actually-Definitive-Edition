 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Festivals;
...
public class Menu_CreateScenario_Events_Cond_FestivalsLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_FestivalsLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Festivals") + " < ");
        this.getTitleM().setText(CFG.lang.get("Festivals"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_FESTIVALS;
