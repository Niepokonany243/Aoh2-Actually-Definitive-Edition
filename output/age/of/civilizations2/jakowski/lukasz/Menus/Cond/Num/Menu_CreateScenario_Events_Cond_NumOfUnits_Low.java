...
public class Menu_CreateScenario_Events_Cond_NumOfUnits_Low
extends Menu {
    public Menu_CreateScenario_Events_Cond_NumOfUnits_Low() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("NumberOfUnits") + " < ");
        this.getTitleM().setText(CFG.lang.get("NumberOfUnits"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NUMOFUNITS;
