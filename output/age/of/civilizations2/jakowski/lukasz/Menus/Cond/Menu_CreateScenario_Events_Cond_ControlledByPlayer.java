...
public class Menu_CreateScenario_Events_Cond_ControlledByPlayer
extends Menu {
    public Menu_CreateScenario_Events_Cond_ControlledByPlayer() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("CivIsControlledByAPlayer"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_CONTROLLEDBYPLAYER;
