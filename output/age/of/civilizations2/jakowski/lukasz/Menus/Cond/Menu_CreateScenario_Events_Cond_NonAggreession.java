...
public class Menu_CreateScenario_Events_Cond_NonAggreession
extends Menu {
    public Menu_CreateScenario_Events_Cond_NonAggreession() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NONAGGRESSION;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 5: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_NONAGGRESSION2;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
            }
        }
    }
