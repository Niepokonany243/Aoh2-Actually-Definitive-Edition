...
public class Menu_CreateScenario_Events_Cond_ControlsProvinces
extends Menu {
    public Menu_CreateScenario_Events_Cond_ControlsProvinces() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("SelectProvinces") + ": " + CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getProvinces().size());
        this.getMenuElem(6).setTextE(CFG.lang.get("PercentageOfProvinces") + ": ");
        this.getTitleM().setText(CFG.lang.get("ControlsProvinces"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_CONTROL_PROVINCES;
            ...
            case 5: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CONTROLS_PROVINCES;
