...
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Technology;
...
public class Menu_CreateScenario_Events_Cond_Technology
extends Menu {
    public Menu_CreateScenario_Events_Cond_Technology() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_TECHNOLOGY;
