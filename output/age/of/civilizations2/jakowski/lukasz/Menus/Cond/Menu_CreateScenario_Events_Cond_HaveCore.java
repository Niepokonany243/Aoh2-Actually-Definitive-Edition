...
public class Menu_CreateScenario_Events_Cond_HaveCore
extends Menu {
    public Menu_CreateScenario_Events_Cond_HaveCore() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("HaveACore"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_CORE;
            ...
            case 5: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_PROVINCES_HAVECORE;
