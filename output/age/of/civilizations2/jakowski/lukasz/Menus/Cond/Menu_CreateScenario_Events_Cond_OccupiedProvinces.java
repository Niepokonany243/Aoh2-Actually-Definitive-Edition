...
public class Menu_CreateScenario_Events_Cond_OccupiedProvinces
extends Menu {
    public Menu_CreateScenario_Events_Cond_OccupiedProvinces() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("OccupiedProvinces"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_CONTROL_OCCUPIED;
            ...
            case 5: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_OCCUPIED_PROVINCES;
