...
package age.of.civilizations2.jakowski.lukasz.Menus.Cond.Invests;
...
public class Menu_CreateScenario_Events_Cond_InvestsLow
extends Menu {
    public Menu_CreateScenario_Events_Cond_InvestsLow() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("Investments") + " " + CFG.lang.get("Economy") + " < ");
        this.getTitleM().setText(CFG.lang.get("Investments") + " " + CFG.lang.get("Economy"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_INVESTSLOW;
