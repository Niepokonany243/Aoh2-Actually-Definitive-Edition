...
public class Menu_CreateScenario_Events_Cond_IsAtWar
extends Menu {
    public Menu_CreateScenario_Events_Cond_IsAtWar() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("IaAtWar"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 4: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.SELECT_CIV_ISATWAR;
