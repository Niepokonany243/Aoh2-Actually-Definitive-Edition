...
public class Menu_InGame_Uncolonized_BorderOrArmy
extends Menu {
    ...
    public Menu_InGame_Uncolonized_BorderOrArmy() {
        ...
        this.sRequiredTech = CFG.lang.get("YouMustBorderTheProvinceOrHaveAnArmyInNeighboringProvince");
    ...
    private final int getWidth2() {
        return (int)((float)Math.max(this.iUncolonizedWidth + CFG.PADD * 2, this.isRequiredTechWidth + CFG.PADD * 2) * 1.5f);
    }
    ...
    public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
        ...
        Renderer.drawText(oSB, CFG.FONT_BOLD_SMALL, this.sRequiredTech, this.getPosX2() + this.getWidth2() / 2 - this.isRequiredTechWidth / 2 + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + iTranslateY, new Color(CFG.COLOR_NEUTRAL.r, CFG.COLOR_NEUTRAL.g, CFG.COLOR_NEUTRAL.b, CFG.COLOR_TEXT_NUM_OF_PROVINCES.a * tAlpha));
    }
}
