...
public class Menu_InGame_ConqueredProvinces
extends Menu {
    public static int iSort = 1;

    public Menu_InGame_ConqueredProvinces(int tInit) {
    ...
    public Menu_InGame_ConqueredProvinces() {
        int i;
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("Civilizations"), CFG.PADD * 2, 2, 0, CFG.BUTTON_W * 2, tElemHeight){
            ...
            public int getWidthE() {
                return Menu_InGame_ConqueredProvinces.this.getElementW() * 2 + CFG.PADD * 2 - 2;
            }
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("ConqueredProvinces"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, 0, CFG.BUTTON_W, tElemHeight){

            @Override
            public int getPosXE() {
                return Menu_InGame_ConqueredProvinces.this.getElementW() * 2 + CFG.PADD * 2;
            }

            @Override
            public int getWidthE() {
                return Menu_InGame_ConqueredProvinces.this.getW() - Menu_InGame_ConqueredProvinces.this.getElementW() * 2 + CFG.PADD * 2 - 2;
            }
            ...
            public void buildElemHover() {
                ...
                ArrayList<ME_Hover_2Type> nData = new ArrayList<ME_Hover_2Type>();
                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("SortBy") + ": "));
                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("ConqueredProvinces"), CFG.COLOR_HOVER_TITLE));
                nElements.add(new MEHover_2E(nData));
                nData.clear();
                this.menuElemHover = new ME_Hover_v2(nElements);
            }
        ...
        if (iSort == 0) {
            for (i = 1; i < CFG.core.getCivsSize(); ++i) {
                tSorted.add(CFG.core.getSortedCivsAZ(i - 1));
            }
        } else if (iSort == 1) {
            ...
            for (int i2 = 1; i2 < CFG.core.getCivsSize(); ++i2) {
                ...
                tempScore.add(CFG.core.getCiv((int)CFG.core.getSortedCivsAZ((int)(i2 - 1))).civGD.numOfConqueredProvinces);
            }
            int tAddID = 0;
        ...
        for (i = 0; i < iSize; ++i) {
            if (CFG.FOG_OF_WAR == 2) {
                if (CFG.getMetCiv((Integer)tSorted.get(i))) {
                    menuElements.add(new Button_Stats_Flag_Clip((int)((Integer)tSorted.get(i)), "" + (i + 1) + ". " + CFG.core.getCiv((Integer)tSorted.get(i)).getCivName(), CFG.PADD, CFG.PADD * 2, tPosY, CFG.BUTTON_W * 2, tElemHeight2){
                        ...
                        @Override
                        public int getWidthE() {
                            return Menu_InGame_ConqueredProvinces.this.getElementW() * 2;
                        }
            ...
            menuElements.add(new ButtonStats(CFG.getNumberWthSpaces("" + CFG.core.getCiv((int)((Integer)tSorted.get((int)i)).intValue()).civGD.numOfConqueredProvinces), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, tPosY, CFG.BUTTON_W, tElemHeight2){
                ...
                @Override
                public int getWidthE() {
                    return Menu_InGame_ConqueredProvinces.this.getW() - Menu_InGame_ConqueredProvinces.this.getElementW() * 2;
                }
            });
            tPosY += tElemHeight2;
        }
        ...
        this.initMenu(new TitleM_TextSmall(null, CFG.BUTTON_H * 3 / 4, true, true){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                oSB.setColor(new Color(0.627451f, 0.07058824f, 0.07058824f, 0.165f));
                ...
                oSB.setColor(new Color(0.627451f, 0.07058824f, 0.07058824f, 0.375f));
    ...
    public void updateLang() {
        try {
            this.getTitleM().setText(CFG.lang.get("ConqueredProvinces"));
        }
