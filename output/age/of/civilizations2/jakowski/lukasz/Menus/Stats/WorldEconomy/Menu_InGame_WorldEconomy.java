...
import age.of.civilizations2.jakowski.lukasz.Menus.Stats.WorldEconomy.Menu_InGame_WorldEconomyContinent;
...
public class Menu_InGame_WorldEconomy
extends Menu {
    public static int iSort = 0;

    public Menu_InGame_WorldEconomy(int tInit) {
    ...
    public Menu_InGame_WorldEconomy() {
        int i;
        int tAdd;
        int i2;
        int i3;
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("Name"), CFG.PADD * 2, 2, 0, CFG.BUTTON_W * 2, tElemHeight){
            ...
            public int getWidthE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 2 + CFG.PADD * 2 - 2;
            }
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("Economy"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 2, 0, CFG.BUTTON_W, tElemHeight){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 2 + CFG.PADD * 2;
            }

            @Override
            public int getWidthE() {
                return Menu_InGame_WorldEconomy.this.getElementW();
            }
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("Civilizations"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 3, 0, CFG.BUTTON_W, tElemHeight){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 3 + CFG.PADD * 2;
            }
        ...
        menuElements.add(new Button_Stats_Title(CFG.lang.get("Provinces"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 4, 0, CFG.BUTTON_W, tElemHeight){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 4 + CFG.PADD * 2;
            }
        ...
        menuElements.add(new Button_Stats_Title("#1 " + CFG.lang.get("Economy"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 4, 0, CFG.BUTTON_W, tElemHeight){

            @Override
            public int getPosXE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 5 + CFG.PADD * 2;
            }
        ...
        menuElements.add(new Button_Stats_Title("#1 " + CFG.lang.get("City"), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, 0, CFG.BUTTON_W, tElemHeight){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 6 + CFG.PADD * 2;
            }

            @Override
            public int getWidthE() {
                return Menu_InGame_WorldEconomy.this.getW() - Menu_InGame_WorldEconomy.this.getElementW() * 6 + CFG.PADD * 2 - 2;
            }
        ...
        ArrayList<ArrayList<Integer>> tCivilizations = new ArrayList<ArrayList<Integer>>();
        ArrayList<Integer> tProvinces = new ArrayList<Integer>();
        ArrayList<Integer> tLargestCity = new ArrayList<Integer>();
        ArrayList<ArrayList<Long>> tMostEconomy2 = new ArrayList<ArrayList<Long>>();
        ArrayList<Integer> tMostEconomyID = new ArrayList<Integer>();
        for (i4 = 0; i4 < CFG.map.getMapContinents().getContinentsSize(); ++i4) {
            tEconomy.add(0L);
            tCivilizations.add(new ArrayList<Integer>());
            tProvinces.add(0);
            tLargestCity.add(-1);
            tMostEconomy2.add(new ArrayList<Long>());
            tMostEconomyID.add(0);
        }
        for (i4 = 0; i4 < CFG.core.getProvinSize(); ++i4) {
            if (CFG.core.getProv(i4).getWastelandLvl() >= 0 || CFG.core.getProv(i4).getSeaProv()) continue;
            tEconomy.set(CFG.core.getProv(i4).getContinent(), tEconomy.get(CFG.core.getProv(i4).getContinent()) + CFG.core.getProv(i4).getEco());
            ...
            if (CFG.core.getProv(i4).getCivId() > 0) {
                boolean tAdd2 = true;
                for (int j = 0; j < tCivilizations.get(CFG.core.getProv(i4).getContinent()).size(); ++j) {
                    if (tCivilizations.get(CFG.core.getProv(i4).getContinent()).get(j).intValue() != CFG.core.getProv(i4).getCivId()) continue;
                    tAdd2 = false;
                    tMostEconomy2.get(CFG.core.getProv(i4).getContinent()).set(j, tMostEconomy2.get(CFG.core.getProv(i4).getContinent()).get(j) + CFG.core.getProv(i4).getEco());
                    break;
                }
                if (tAdd2) {
                    tCivilizations.get(CFG.core.getProv(i4).getContinent()).add(CFG.core.getProv(i4).getCivId());
                    tMostEconomy2.get(CFG.core.getProv(i4).getContinent()).add((long)CFG.core.getProv(i4).getEco());
                }
            }
            ...
            if (CFG.core.getProv((Integer)tLargestCity.get(CFG.core.getProv(i4).getContinent())).getEco() >= CFG.core.getProv(i4).getEco()) continue;
            tLargestCity.set(CFG.core.getProv(i4).getContinent(), i4);
        }
        ...
        long tempMostPopulation = Math.max(1L, CFG.core.getCiv(tMostPopulousTotal).countEco());
        for (i3 = 0; i3 < tEconomy.size(); ++i3) {
            tTotalPop += tEconomy.get(i3);
            ...
            if ((Integer)tLargestCity.get(i3) < 0 || CFG.core.getProv(tLargestCityTotal).getEco() >= CFG.core.getProv((Integer)tLargestCity.get(i3)).getEco()) continue;
            tLargestCityTotal = (Integer)tLargestCity.get(i3);
        }
        for (i3 = 1; i3 < CFG.core.getCivsSize(); ++i3) {
            if (CFG.core.getCiv(i3).getNumOfProvs() <= 0) continue;
            ++tCivsTotal;
            if (CFG.core.getCiv(i3).countEco() <= (long)tempMostPopulation) continue;
            tMostPopulousTotal = i3;
            tempMostPopulation = (int)Math.max(1L, CFG.core.getCiv(tMostPopulousTotal).countEco());
        }
        menuElements.add(new Button_Stats_Color(new Color(1.0f, 1.0f, 1.0f, 0.95f), "" + CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()), CFG.PADD, CFG.PADD * 2, tPosY, CFG.BUTTON_W * 2, tElemHeight2){
            ...
            @Override
            public int getWidthE() {
                return Menu_InGame_WorldEconomy.this.getElementW() * 2;
            }
        ...
        menuElements.add(new Button_Stats_Flag_Clip_ProvinceID(CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(tLargestCityTotal) ? tLargestCityTotal : -1) : tLargestCityTotal, CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(tLargestCityTotal) ? (CFG.core.getProv(tLargestCityTotal).getCitSize() > 0 ? CFG.core.getProv(tLargestCityTotal).getCit(0).getCityName() : (CFG.core.getProv(tLargestCityTotal).getName().length() > 0 ? CFG.core.getProv(tLargestCityTotal).getName() : CFG.lang.get("NoData"))) : CFG.lang.get("Undiscovered")) : (CFG.core.getProv(tLargestCityTotal).getCitSize() > 0 ? CFG.core.getProv(tLargestCityTotal).getCit(0).getCityName() : (CFG.core.getProv(tLargestCityTotal).getName().length() > 0 ? CFG.core.getProv(tLargestCityTotal).getName() : CFG.lang.get("NoData"))), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, tPosY, CFG.BUTTON_W, tElemHeight2){
            ...
            @Override
            public int getWidthE() {
                return Menu_InGame_WorldEconomy.this.getW() - Menu_InGame_WorldEconomy.this.getElementW() * 6;
            }
        ...
        if (iSort == 0) {
            ...
            while (tempIDs.size() > 0) {
                tAdd = 0;
                for (i = 1; i < tempIDs.size(); ++i) {
                    if (tEconomy.get((Integer)tempIDs.get(tAdd)) >= tEconomy.get((Integer)tempIDs.get(i))) continue;
                    tAdd = i;
                }
                tSorted.add((Integer)tempIDs.get(tAdd));
                tempIDs.remove(tAdd);
            ...
            while (tempIDs.size() > 0) {
                ...
                for (i = 1; i < tempIDs.size(); ++i) {
                    try {
                        ...
                        if (((List)tMostEconomy2.get((Integer)tempIDs.get(tAdd))).size() != 0) continue;
                        tAdd = i;
                    }
                }
                tSorted.add((Integer)tempIDs.get(tAdd));
        ...
        for (i2 = 0; i2 < tSorted.size(); ++i2) {
            ...
            try {
                menuElements.add(new Button_Stats_Flag_Clip(CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetCiv((Integer)((List)tCivilizations.get((Integer)tSorted.get(i2))).get((Integer)tMostEconomyID.get((Integer)tSorted.get(i2)))) ? (Integer)((List)tCivilizations.get((Integer)tSorted.get(i2))).get((Integer)tMostEconomyID.get((Integer)tSorted.get(i2))) : -1) : (Integer)((List)tCivilizations.get((Integer)tSorted.get(i2))).get((Integer)tMostEconomyID.get((Integer)tSorted.get(i2))), CFG.getNumberWthSpaces("" + ((List)tMostEconomy2.get((Integer)tSorted.get(i2))).get((Integer)tMostEconomyID.get((Integer)tSorted.get(i2)))), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 4, tPosY, CFG.BUTTON_W, tElemHeight2){
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("Economy"), CFG.BUTTON_H * 3 / 4, true, true){
            ...
            if (iID % 6 == 5) {
                ...
                try {
                    ...
                    for (int i = 0; i < CFG.map.getMapContinents().getContinentsSize(); ++i) {
                        ...
                        Menu_InGame_WorldEconomyContinent.CONTINENT_ID = i;
