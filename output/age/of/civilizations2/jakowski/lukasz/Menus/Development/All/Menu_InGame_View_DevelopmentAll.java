...
import age.of.civilizations2.jakowski.lukasz.Button.GameN.Population.ButtonN_Pop_3Cost;
...
public class Menu_InGame_View_DevelopmentAll
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;

    public Menu_InGame_View_DevelopmentAll() {
        ...
        if (GameCalendar.TURNID == 1) {
            for (int a = 1; a < CFG.core.getCivsSize(); ++a) {
                CFG.core.countAverageDevelopmentLevel_Float(a);
            }
        }
        for (int i = 1; i < CFG.core.getCivsSize(); ++i) {
            if (CFG.core.getCiv(i).getNumOfProvs() <= 0) continue;
            tCivs.add(i);
            totalDev += CFG.core.getCiv((int)i).fAverageDevelopment;
        }
        if (!tCivs.isEmpty()) {
            totalDev /= (float)tCivs.size();
        }
        menuElements.add(new Button_DiplomacyAction(Images.development, CFG.lang.get("AverageDevelopment") + ": " + CFG.getPrecision2(totalDev, 100), 0, 0, tY, tempW, Menu_InGame_Civ_Decisions.getButtonH(), true){
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Development") + ": "));
        ...
        if (!tCivs.isEmpty()) {
            ...
            while (!tCivs.isEmpty()) {
                ...
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (!(CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fAverageDevelopment < CFG.core.getCiv((int)((Integer)tCivs.get((int)o)).intValue()).fAverageDevelopment)) continue;
                    toAddID = o;
                }
                ...
                menuElements.add(new ButtonN_Pop_3Cost(new Color((float)CFG.core.getCiv(civID).getR() / 255.0f, (float)CFG.core.getCiv(civID).getG() / 255.0f, (float)CFG.core.getCiv(civID).getB() / 255.0f, 1.0f), rankID++ + ". " + (metCiv ? CFG.core.getCiv(civID).getCivName() : CFG.lang.get("Undiscovered")), metCiv ? civID : -1, "" + CFG.getPrecision2(CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fAverageDevelopment / CFG.core.getCiv((Integer)tCivs.get(toAddID)).getTechLevel() * 100.0f, 100) + "%", CFG.getPrecision2(CFG.core.getCiv((int)((Integer)tCivs.get((int)toAddID)).intValue()).fAverageDevelopment, 100), Images.development, CFG.COLOR_NEUTRAL2, 0, tY, tempW, "" + CFG.getPrecision2(CFG.core.getCiv((Integer)tCivs.get(toAddID)).getTechLevel(), 100), CFG.COLOR_NEUTRAL, Images.technology, CFG.getNumberWthSpaces("" + CFG.core.getCiv((int)civID).civGD.iGD)){
                    ...
                    public void buildElemHover() {
                        try {
                            ...
                            if (this.iCivID > 0) {
                                ...
                                nData.add(new ME_Hover_2Type_Text(" [" + CFG.getPrecision2(CFG.core.getCiv((int)this.iCivID).fAverageDevelopment / CFG.core.getCiv(this.iCivID).getTechLevel() * 100.0f, 100) + "%]", CFG.COLOR_TEXT_GRAY_NS));
                                ...
                                nData.add(new ME_Hover_2Type_Text(CFG.getPrecision2(CFG.core.getCiv(this.iCivID).getTechLevel(), 100), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                                nData.add(new ME_Hover_2Type_Image(Images.technology, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Space());
                                ...
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("AverageDevelopment") + ": "));
                                nData.add(new ME_Hover_2Type_Text(this.sDeaths, CFG.COLOR_NEUTRAL2));
                                nData.add(new ME_Hover_2Type_Image(Images.development, CFG.PADD, 0));
                                ...
                                nData.clear();
                                nData.add(new ME_Hover_2Type_Text(CFG.lang.get("TechnologyLevel") + ": "));
                                nData.add(new ME_Hover_2Type_Text(this.sText2, CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                                nData.add(new ME_Hover_2Type_Image(Images.technology, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
                            }
        ...
        this.initMenu(new TitleM_TextSmall(CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()) + ": " + CFG.lang.get("Development") + (playerRankID > 0 ? " #" + playerRankID : ""), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_DevelopmentAll.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_DevelopmentAll.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_DevelopmentAll.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_DevelopmentAll.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentAll.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentAll.this.getPosX() + Menu_InGame_View_DevelopmentAll.this.getWidthM() - Menu_InGame_View_DevelopmentAll.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentAll.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.development).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_DevelopmentAll.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.development).getHeight() / 2);
