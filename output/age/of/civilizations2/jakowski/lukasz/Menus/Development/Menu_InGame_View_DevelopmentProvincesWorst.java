...
public class Menu_InGame_View_DevelopmentProvincesWorst
extends Menu {
    ...
    public Menu_InGame_View_DevelopmentProvincesWorst() {
        ...
        this.initMenu(new TitleM_TextSmall(CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()) + ": " + CFG.lang.get("WorstProvinces"), CFG.BUTTON_H * 3 / 5, false, false){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosX() + Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM() - Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentProvincesWorst.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.development).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_DevelopmentProvincesWorst.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.development).getHeight() / 2);
