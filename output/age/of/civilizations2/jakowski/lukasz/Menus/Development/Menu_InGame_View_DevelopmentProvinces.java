 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Development;
...
public class Menu_InGame_View_DevelopmentProvinces
extends Menu {
    ...
    public Menu_InGame_View_DevelopmentProvinces() {
        int tempW = CFG.CIV_INFO_MENU_WIDTH;
        int tY = 0;
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        menuElements.add(new Button_DiplomacyAction(Images.development, CFG.lang.get("Development") + ": " + CFG.lang.get("Civilization"), 0, 0, tY, tempW, Menu_InGame_Civ_Decisions.getButtonH(), true){
        ...
        menuElements.add(new Button_DiplomacyAction(Images.development, CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()) + ": " + CFG.lang.get("WorstProvinces"), 0, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE(), tempW, Menu_InGame_Civ_Decisions.getButtonH(), true){

            @Override
            public void actionElem(int iID) {
                CFG.menus.setVisible_InGame_ViewDevelopmentProvincesWorst(true);
            }
        ...
        for (int i = 0; i < CFG.core.getProvinSize(); ++i) {
            ...
            topScore.add(Float.valueOf(CFG.core.getProv(i).getDeveLvl()));
        }
        for (int a = 0; a < GameValues.gvInGame.TOP_PROVINCES_LIMIT; ++a) {
            int bestID = 0;
            for (int i = 0; i < CFG.core.getProvinSize(); ++i) {
                if (!(((Float)topScore.get(i)).floatValue() > ((Float)topScore.get(bestID)).floatValue())) continue;
                bestID = i;
            }
            if (((Float)topScore.get(bestID)).floatValue() < 0.0f) break;
            menuElements.add(new Button_View_Development(a % 2, a + 1 + ". " + (CFG.core.getProv(bestID).getName().length() > 0 ? CFG.core.getProv(bestID).getName() : CFG.core.getCiv(CFG.core.getProv(bestID).getCivId()).getCivName()) + ": ", bestID, 0, tY, tempW, (CFG.SANDBOX_MODE || CFG.SPECTATOR_MODE || CFG.core.isAlly(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId(), CFG.core.getProv(bestID).getCivId())) && CFG.core.getCiv(CFG.core.getProv(bestID).getCivId()).isInvestOrganized_Devel(bestID)){
        ...
        this.initMenu(new TitleM_TextSmall(CFG.map.getMapName_Just(CFG.map.getActiveMapIDN()) + ": " + CFG.lang.get("TopProvinces"), CFG.BUTTON_H * 3 / 5, false, false){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_DevelopmentProvinces.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_DevelopmentProvinces.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_DevelopmentProvinces.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_DevelopmentProvinces.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentProvinces.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_DevelopmentProvinces.this.getPosX() + Menu_InGame_View_DevelopmentProvinces.this.getWidthM() - Menu_InGame_View_DevelopmentProvinces.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_DevelopmentProvinces.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.development).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_DevelopmentProvinces.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.development).getHeight() / 2);
