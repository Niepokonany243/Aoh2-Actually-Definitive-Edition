...
public class Menu_MapEditor_FormableCivs_SelectFormable_Alphabet
extends Menu {
    ...
    public Menu_MapEditor_FormableCivs_SelectFormable_Alphabet() {
        ...
        menuElements.add(new Button_Classic_Classic_Search("", CFG.PADD * 2, 0, CFG.PADD, CFG.BUTTON_W * 2, CFG.BUTTON_H, true){
            ...
            public String getTextToDrawElem() {
                return Menu_MapEditor_FormableCivs_SelectFormable_Alphabet.this.nSearch + ": " + super.getTextToDrawElem();
            }
        });
