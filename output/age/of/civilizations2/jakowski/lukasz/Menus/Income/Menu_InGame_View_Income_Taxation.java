...
import age.of.civilizations2.jakowski.lukasz.Button.View.Button_View_Income_TaxationBold;
...
public class Menu_InGame_View_Income_Taxation
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;

    public Menu_InGame_View_Income_Taxation() {
        ...
        for (int added = 0; !tempProvs.isEmpty() && added < GameValues.gvInGame.INCOME_ALL_VIEW_LIMIT_PROVINCES; ++added) {
            ...
            for (int i = 1; i < tempProvs.size(); ++i) {
                if (!(CFG.core.getProv((int)((Integer)tempProvs.get((int)tBest)).intValue()).incomeTaxation < CFG.core.getProv((int)((Integer)tempProvs.get((int)i)).intValue()).incomeTaxation)) continue;
                tBest = i;
            }
            menuElements.add(new Button_View_Income_TaxationBold(added, added + 1 + ". " + (CFG.core.getProv((Integer)tempProvs.get(tBest)).getName().length() > 0 ? CFG.core.getProv((Integer)tempProvs.get(tBest)).getName() : CFG.core.getCiv(CFG.core.getProv((Integer)tempProvs.get(tBest)).getCivId()).getCivName()), (Integer)tempProvs.get(tBest), 0, tY, tempW, (CFG.SPECTATOR_MODE || CFG.core.isAlly(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId(), CFG.core.getProv((Integer)tempProvs.get(tBest)).getCivId())) && CFG.core.getCiv(CFG.core.getProv((Integer)tempProvs.get(tBest)).getCivId()).isInConstruction((Integer)tempProvs.get(tBest), ConstructionType.WORKSHOP) > 0){
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("IncomeTaxation"), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_Income_Taxation.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                oSB.setColor(new Color(0.627451f, 0.32156864f, 0.1764706f, 0.165f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, nPosX + iTranslateX, nPosY - this.getHeightT() + 2 - IMGManager.getIMG(Images.line32Off1).getHeight(), nWidth, this.getHeightT() - 2, false, true);
                oSB.setColor(new Color(0.627451f, 0.32156864f, 0.1764706f, 0.375f));
                IMGManager.getIMG(Images.gradient).drawO(oSB, nPosX + iTranslateX, nPosY - this.getHeightT() * 2 / 3 - IMGManager.getIMG(Images.gradient).getHeight(), nWidth, this.getHeightT() * 2 / 3, false, true);
                oSB.setColor(CFG.COLOR_NEW_GAME_EDGE_LINE);
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_Income_Taxation.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_Income_Taxation.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_Income_Taxation.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_Income_Taxation.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_Income_Taxation.this.getPosX() + Menu_InGame_View_Income_Taxation.this.getWidthM() - Menu_InGame_View_Income_Taxation.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_Income_Taxation.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.topGold()).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_Income_Taxation.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.topGold()).getHeight() / 2);
