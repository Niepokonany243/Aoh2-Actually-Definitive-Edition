...
public class Menu_ManageDiplomacy_DefensivePact
extends Menu {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            case 2: {
                CFG.core.setDefensivePact(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2, 5);
