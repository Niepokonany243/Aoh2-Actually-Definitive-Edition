...
public class Menu_ManageDiplomacy_Guarantee
extends Menu {
    public Menu_ManageDiplomacy_Guarantee() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            case 2: {
                CFG.core.setGuarantee(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2, 5);
