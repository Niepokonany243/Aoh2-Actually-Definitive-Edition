...
public class Menu_InGame_View_EconomyChangeCivsWorst
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;

    public Menu_InGame_View_EconomyChangeCivsWorst() {
        ...
        menuElements.add(new Button_DiplomacyAction(Images.economy, CFG.lang.get("TopCivilizations"), 0, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE(), tempW, Menu_InGame_Civ_Decisions.getButtonH(), true){

            @Override
            public void actionElem(int iID) {
                CFG.menus.setVisible_InGame_ViewEconomicChangeCivs(true);
            }
            ...
            public void buildElemHover() {
                ...
                ArrayList<ME_Hover_2Type> nData = new ArrayList<ME_Hover_2Type>();
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("EconomicChange") + ": "));
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("TopCivilizations"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                nData.add(new ME_Hover_2Type_Image_Big(Images.economy, CFG.PADD, 0));
                nElements.add(new MEHover_2E(nData));
                nData.clear();
                this.menuElemHover = new ME_Hover_v2(nElements);
        ...
        menuElements.add(new TextBuildTitle(CFG.lang.get("WorstCivilizations"), -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE(), tempW, CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 4){
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("EconomicChange") + (playerPos > 0 ? " #" + playerPos : ""), CFG.BUTTON_H * 3 / 5, false, false){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosX() + Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM() - Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_EconomyChangeCivsWorst.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.economy).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_EconomyChangeCivsWorst.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.economy).getHeight() / 2);
