...
public class Menu_CreateScenario_Events_Out_GoldenAgeScie
extends Menu {
    public Menu_CreateScenario_Events_Out_GoldenAgeScie() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("GoldenAge") + ": " + CFG.lang.get("GAScience"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_GOLDEN_SCIE;
