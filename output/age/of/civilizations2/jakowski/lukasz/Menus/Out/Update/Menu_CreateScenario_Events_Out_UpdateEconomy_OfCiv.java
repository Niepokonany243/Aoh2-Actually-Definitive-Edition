...
public class Menu_CreateScenario_Events_Out_UpdateEconomy_OfCiv
extends Menu {
    public Menu_CreateScenario_Events_Out_UpdateEconomy_OfCiv() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("UpdateEconomyOfCiv"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_UPDATEECONOMY_OFCIV;
