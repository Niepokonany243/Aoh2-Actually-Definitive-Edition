...
public class Menu_CreateScenario_Events_Out_UpdateEconomy
extends Menu {
    public Menu_CreateScenario_Events_Out_UpdateEconomy() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("UpdateEconomy"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_UPDATEECONOMY;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVICNES_UPDATEECONOMY;
