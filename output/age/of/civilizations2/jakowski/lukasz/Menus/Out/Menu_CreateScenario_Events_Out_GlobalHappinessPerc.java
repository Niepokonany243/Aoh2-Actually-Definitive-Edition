...
public class Menu_CreateScenario_Events_Out_GlobalHappinessPerc
extends Menu {
    public Menu_CreateScenario_Events_Out_GlobalHappinessPerc() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("Happiness") + " - " + CFG.lang.get("AllCivilizations"));
    }
