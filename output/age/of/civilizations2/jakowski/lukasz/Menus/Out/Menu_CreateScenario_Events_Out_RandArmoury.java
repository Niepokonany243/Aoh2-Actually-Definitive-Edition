...
public class Menu_CreateScenario_Events_Out_RandArmoury
extends Menu {
    public Menu_CreateScenario_Events_Out_RandArmoury() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("Build") + " " + CFG.lang.get("OR") + " " + CFG.lang.get("Destroy") + ": " + CFG.lang.get("Armoury") + ": ");
        this.getTitleM().setText(CFG.lang.get("Build") + " " + CFG.lang.get("OR") + " " + CFG.lang.get("Destroy") + ": " + CFG.lang.get("Armoury"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_RAND_ARMOURY;
