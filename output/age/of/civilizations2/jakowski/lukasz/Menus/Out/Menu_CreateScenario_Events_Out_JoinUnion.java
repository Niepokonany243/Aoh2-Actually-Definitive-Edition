...
public class Menu_CreateScenario_Events_Out_JoinUnion
extends Menu {
    public Menu_CreateScenario_Events_Out_JoinUnion() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("CreateUnion"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_JOINUNION_A;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 2: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_JOINUNION_B;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
            }
        }
    }
