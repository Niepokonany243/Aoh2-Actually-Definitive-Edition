...
public class Menu_CreateScenario_Events_Out_MilitaryAttack
extends Menu {
    public Menu_CreateScenario_Events_Out_MilitaryAttack() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Attack") + ": ");
        this.getTitleM().setText(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Attack"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_MILITARYATTACK;
