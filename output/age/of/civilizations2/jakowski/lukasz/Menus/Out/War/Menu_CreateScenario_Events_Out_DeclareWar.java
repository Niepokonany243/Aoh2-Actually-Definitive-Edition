...
package age.of.civilizations2.jakowski.lukasz.Menus.Out.War;
...
public class Menu_CreateScenario_Events_Out_DeclareWar
extends Menu {
    public Menu_CreateScenario_Events_Out_DeclareWar() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("DeclareWar"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_DECLAREWAR_A;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 2: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_DECLAREWAR_B;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
            }
        }
    }
