...
public class Menu_CreateScenario_Events_Out_ChangeIdeology
extends Menu {
    public Menu_CreateScenario_Events_Out_ChangeIdeology() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(2).setTextE(CFG.lang.get("Government") + ": " + (CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue() >= 0 ? CFG.ideologiesMgr.getIdeologyID((int)CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()).getName() : ""));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(2).setTextE(CFG.lang.get("Government") + ": ");
        }
        this.getTitleM().setText(CFG.lang.get("ChangeIdeology"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 2: {
                ...
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECTIDEOLOGY);
            }
        }
    }
