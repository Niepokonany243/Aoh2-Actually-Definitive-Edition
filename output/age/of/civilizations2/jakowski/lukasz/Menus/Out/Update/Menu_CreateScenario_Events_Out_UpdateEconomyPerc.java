...
public class Menu_CreateScenario_Events_Out_UpdateEconomyPerc
extends Menu {
    public Menu_CreateScenario_Events_Out_UpdateEconomyPerc() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(3).setTextE(CFG.lang.get("Economy") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdateEconomyPercentage"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_UPDATEECONOMY_PERC;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVICNES_UPDATEECONOMY_PERC;
