...
public class Menu_CreateScenario_Events_Out_Leader
extends Menu {
    public Menu_CreateScenario_Events_Out_Leader() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(2).setTextE(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getText());
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(2).setTextE(CFG.lang.get("ChangeLeader"));
        }
        this.getTitleM().setText(CFG.lang.get("ChangeLeader"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_LEADER;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 2: {
                Menu_CreateScenario_Leaders.backTo = View.eCREATE_SCENARIO_EVENTS_OUT_LEADER;
