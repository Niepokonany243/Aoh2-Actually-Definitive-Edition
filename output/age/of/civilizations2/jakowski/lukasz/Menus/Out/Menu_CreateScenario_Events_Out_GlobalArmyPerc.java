...
public class Menu_CreateScenario_Events_Out_GlobalArmyPerc
extends Menu {
    public Menu_CreateScenario_Events_Out_GlobalArmyPerc() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("Army") + " - " + CFG.lang.get("AllCivilizations"));
    }
