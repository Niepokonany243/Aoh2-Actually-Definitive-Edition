...
public class Menu_CreateScenario_Events_Out_PlayerCiv
extends Menu {
    public Menu_CreateScenario_Events_Out_PlayerCiv() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Player") + ", " + CFG.lang.get("Civilization"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_PLAYERCIV;
