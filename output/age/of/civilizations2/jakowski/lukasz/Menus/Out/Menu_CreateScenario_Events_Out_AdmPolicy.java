...
public class Menu_CreateScenario_Events_Out_AdmPolicy
extends Menu {
    public Menu_CreateScenario_Events_Out_AdmPolicy() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(2).setTextE(CFG.lang.get("AdministrationPolicy") + ": " + CFG.lang.get(GameValues.gvAdministrationPolicy.POLICY_NAME[(int)CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()]));
        }
        catch (Exception ex) {
            this.getMenuElem(2).setTextE(CFG.lang.get("AdministrationPolicy") + ": ");
        }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_ADM_POLICY;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 2: {
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_OUT_ADM_POLICYLIST);
            }
        }
    }
