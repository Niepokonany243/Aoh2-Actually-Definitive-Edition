...
public class Menu_CreateScenario_Events_Out_Happiness
extends Menu {
    public Menu_CreateScenario_Events_Out_Happiness() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(3).setTextE(CFG.lang.get("Happiness") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdateHappiness"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_HAPPINESS;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVICNES_HAPPINESS;
