...
public class Menu_CreateScenario_Events_Out_CreateAVassal
extends Menu {
    public Menu_CreateScenario_Events_Out_CreateAVassal() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(1).setTextE((CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID() >= 0 ? CFG.lang.get("Lord") + ": " + CFG.core.getCiv(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID()).getCivName() : CFG.lang.get("Lord")) + " -> " + CFG.lang.get("OutComeAddCiv"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(1).setTextE(CFG.lang.get("Lord") + " -> " + CFG.lang.get("OutComeAddCiv"));
        }
        try {
            this.getMenuElem(2).setTextE((CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID2() >= 0 ? CFG.lang.get("Vassal") + ": " + CFG.core.getCiv(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID2()).getCivName() : CFG.lang.get("Vassal")) + " -> " + CFG.lang.get("OutComeAddCiv2"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(2).setTextE(CFG.lang.get("Vassal") + " -> " + CFG.lang.get("OutComeAddCiv2"));
        }
        ...
        this.getTitleM().setText(CFG.lang.get("AddCivilization") + " | " + CFG.lang.get("OR") + " | " + CFG.lang.get("CreateAVassal") + " - AoH2:DE");
    }
