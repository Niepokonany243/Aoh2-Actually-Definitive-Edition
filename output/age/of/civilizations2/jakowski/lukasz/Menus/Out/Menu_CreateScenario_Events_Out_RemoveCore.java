...
public class Menu_CreateScenario_Events_Out_RemoveCore
extends Menu {
    public Menu_CreateScenario_Events_Out_RemoveCore() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("RemoveCore"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_REMOVECORE;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVINCES_REMOVECORE;
