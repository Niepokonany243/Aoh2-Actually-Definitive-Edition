...
public class Menu_CreateScenario_Events_Out_MilitaryExp
extends Menu {
    public Menu_CreateScenario_Events_Out_MilitaryExp() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("MilitaryExpertise") + ": ");
        this.getTitleM().setText(CFG.lang.get("MilitaryExpertise"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_MILITARYEXP;
