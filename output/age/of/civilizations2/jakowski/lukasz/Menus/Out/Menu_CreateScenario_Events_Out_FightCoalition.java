...
public class Menu_CreateScenario_Events_Out_FightCoalition
extends Menu {
    public Menu_CreateScenario_Events_Out_FightCoalition() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("FightTheCoalition"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_COALITION;
