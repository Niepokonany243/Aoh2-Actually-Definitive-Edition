...
public class Menu_CreateScenario_Events_Out_MovementPoints
extends Menu {
    public Menu_CreateScenario_Events_Out_MovementPoints() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("MovementPoints") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdateMovementPoints"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_MOVEMENTPOINTS;
