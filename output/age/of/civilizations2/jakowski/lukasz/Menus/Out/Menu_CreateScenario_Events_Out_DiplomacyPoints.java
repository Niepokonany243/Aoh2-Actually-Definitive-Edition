...
public class Menu_CreateScenario_Events_Out_DiplomacyPoints
extends Menu {
    public Menu_CreateScenario_Events_Out_DiplomacyPoints() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("DiplomacyPoints") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdateDiplomacyPoints"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_DIPLOMACYPOINTS;
