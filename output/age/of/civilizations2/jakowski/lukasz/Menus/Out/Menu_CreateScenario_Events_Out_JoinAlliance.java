...
public class Menu_CreateScenario_Events_Out_JoinAlliance
extends Menu {
    public String sName = "";
    ...
    public Menu_CreateScenario_Events_Out_JoinAlliance() {
        ...
        menuElements.add(new Button_Classic(null, (int)(50.0f * CFG.GUI_SCALE), 0, tY, CFG.GAMEWIDTH, CFG.BUTTON_H, true){
            ...
            public String getTextToDrawElem() {
                return Menu_CreateScenario_Events_Out_JoinAlliance.this.sName + ": " + this.getTextE();
            }
        });
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(3).setTextE(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID2() >= 0 ? CFG.lang.get("Civilization") + ": " + CFG.core.getCiv(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getCivID2()).getCivName() : CFG.lang.get("SelectCivilization"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(3).setTextE(CFG.lang.get("SelectCivilization"));
        }
        this.sName = CFG.lang.get("AllianceName") + " [" + CFG.lang.get("Optional") + "]: ";
        this.getMenuElem(1).setTextE(CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getText());
        this.getTitleM().setText(CFG.lang.get("JoinAlliance"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 2: {
                CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).setText(this.getMenuElem(1).getTextE());
