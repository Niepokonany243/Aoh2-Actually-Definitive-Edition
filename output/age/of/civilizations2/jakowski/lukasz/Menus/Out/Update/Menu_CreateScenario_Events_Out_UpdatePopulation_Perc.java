...
public class Menu_CreateScenario_Events_Out_UpdatePopulation_Perc
extends Menu {
    public Menu_CreateScenario_Events_Out_UpdatePopulation_Perc() {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("SelectProvinces") + ": " + CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getProvinces().size());
        this.getMenuElem(3).setTextE(CFG.lang.get("Percentage") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdatePopulationPercentage"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_UPDATEPOPULAION_PERC;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVICNES_UPDATEPOPULAION_PERC;
