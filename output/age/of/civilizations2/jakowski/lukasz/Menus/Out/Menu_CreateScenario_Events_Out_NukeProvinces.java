...
public class Menu_CreateScenario_Events_Out_NukeProvinces
extends Menu {
    public Menu_CreateScenario_Events_Out_NukeProvinces() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("AtomicBombing") + ": " + CFG.lang.get("SelectProvinces"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_NUKESDROP;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_NUKESDROPPROVINCES;
