...
public class Menu_CreateScenario_Events_Out_TriggerAnotherEvent
extends Menu {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(1).setTextE(CFG.lang.get("Event") + ": " + CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getText());
        this.getTitleM().setText(CFG.lang.get("TriggerAnotherEvent"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                ...
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_OUT_SELECT_EVENT);
            }
        }
    }
