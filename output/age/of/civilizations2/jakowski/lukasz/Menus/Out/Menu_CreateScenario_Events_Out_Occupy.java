...
public class Menu_CreateScenario_Events_Out_Occupy
extends Menu {
    public Menu_CreateScenario_Events_Out_Occupy() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Occupy"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV2_OCCUPY;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 2: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_OCCUPY;
                CFG.menus.setMenuID(View.eCREATE_SCENARIO_EVENTS_SELECT_CIV);
                break;
            }
            case 3: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVINCES_OCCUPY;
