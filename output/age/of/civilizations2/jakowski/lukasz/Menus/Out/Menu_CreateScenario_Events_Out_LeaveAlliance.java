...
public class Menu_CreateScenario_Events_Out_LeaveAlliance
extends Menu {
    public Menu_CreateScenario_Events_Out_LeaveAlliance() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("LeaveAlliance"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_LEAVEALLIANCE;
