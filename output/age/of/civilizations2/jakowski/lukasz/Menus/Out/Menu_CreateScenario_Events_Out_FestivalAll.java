...
public class Menu_CreateScenario_Events_Out_FestivalAll
extends Menu {
    public Menu_CreateScenario_Events_Out_FestivalAll() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("Festival") + ": " + CFG.lang.get("AllProvinces"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_FESTIVALALL;
