...
public class Menu_CreateScenario_Events_Out_TechLevel
extends Menu {
    public Menu_CreateScenario_Events_Out_TechLevel() {
        ...
        menuElements.add(new Slider_BG(0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD * 2, CFG.GAMEWIDTH, CFG.BUTTON_H - CFG.PADD * 2, -100, 100, CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()){
            ...
            public String getDrawText() {
                return (this.getCurr() > 0 ? "+" : "") + (float)this.getCurr() / 100.0f;
            }
        });
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("UpdateTechnologyLevel"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_TECHLEVEL;
