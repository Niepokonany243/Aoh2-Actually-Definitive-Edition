...
public class Menu_CreateScenario_Events_Out_ProvokeRebels
extends Menu {
    public Menu_CreateScenario_Events_Out_ProvokeRebels() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("ProvokeRebels"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_PROVOKE_REBELS;
