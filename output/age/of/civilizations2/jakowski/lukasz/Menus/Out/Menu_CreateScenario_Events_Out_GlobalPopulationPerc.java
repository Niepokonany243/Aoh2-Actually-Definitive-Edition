...
public class Menu_CreateScenario_Events_Out_GlobalPopulationPerc
extends Menu {
    public Menu_CreateScenario_Events_Out_GlobalPopulationPerc() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("GlobalEvent") + ": " + CFG.lang.get("PopulationChange") + " - " + CFG.lang.get("AllCivilizations"));
    }
