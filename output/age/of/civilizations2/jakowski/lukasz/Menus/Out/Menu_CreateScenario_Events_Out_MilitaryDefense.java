...
public class Menu_CreateScenario_Events_Out_MilitaryDefense
extends Menu {
    public Menu_CreateScenario_Events_Out_MilitaryDefense() {
        ...
        menuElements.add(new Slider_BG(0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD * 2, CFG.GAMEWIDTH, CFG.BUTTON_H - CFG.PADD * 2, -10, 20, CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()){
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Defense") + ": ");
        this.getTitleM().setText(CFG.lang.get("MilitaryExpertise") + ", " + CFG.lang.get("Defense"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_MILITARYDEFENSE;
