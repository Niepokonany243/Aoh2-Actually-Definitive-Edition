...
public class Menu_CreateScenario_Events_Out_MoveCapital
extends Menu {
    public Menu_CreateScenario_Events_Out_MoveCapital() {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(2).setTextE(CFG.lang.get("Capital") + ": " + (CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue() >= 0 ? CFG.core.getProv((int)CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()).getName() : ""));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElem(2).setTextE(CFG.lang.get("Capital") + ": ");
        }
        this.getTitleM().setText(CFG.lang.get("MoveCapital"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_MOVECAPITAL;
            ...
            case 2: {
                ...
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTPROVICNES_MOVECAPITAL;
