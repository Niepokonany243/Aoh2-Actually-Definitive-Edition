 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Out.Update;
...
public class Menu_CreateScenario_Events_Out_UpdatePopulation_OfCiv
extends Menu {
    public Menu_CreateScenario_Events_Out_UpdatePopulation_OfCiv() {
        ...
        menuElements.add(new Slider_BG(0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, CFG.GAMEWIDTH, CFG.BUTTON_H - CFG.PADD * 2, -100, 100, CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()){
    ...
    public void updateLang() {
        ...
        this.getMenuElem(2).setTextE(CFG.lang.get("Percentage") + ": ");
        this.getTitleM().setText(CFG.lang.get("UpdatePopulationOfCiv"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            ...
            case 1: {
                CFG.eventsManager.eSelectCivAction = Event_SelectCivAction.OUT_SELECTCIV_UPDATEPOPULAION_OFCIV;
