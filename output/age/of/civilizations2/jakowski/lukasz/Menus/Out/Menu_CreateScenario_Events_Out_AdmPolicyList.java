...
public class Menu_CreateScenario_Events_Out_AdmPolicyList
extends Menu {
    public Menu_CreateScenario_Events_Out_AdmPolicyList() {
    ...
    public final void actionEL(int iID) {
        ...
        CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).setValue(iID - 1);
        this.onBackPressed();
    }
