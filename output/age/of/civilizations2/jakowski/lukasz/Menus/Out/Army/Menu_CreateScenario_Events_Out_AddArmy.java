 ...
 */
package age.of.civilizations2.jakowski.lukasz.Menus.Out.Army;
...
public class Menu_CreateScenario_Events_Out_AddArmy
extends Menu {
    public Menu_CreateScenario_Events_Out_AddArmy() {
        ...
        menuElements.add(new Slider_BG(0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD * 2, CFG.GAMEWIDTH, CFG.BUTTON_H - CFG.PADD * 2, 0, 100000, CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()));
    ...
    public void updateLang() {
        ...
        this.getMenuElem(3).setTextE(CFG.lang.get("Army") + ": ");
        this.getTitleM().setText(CFG.lang.get("AddArmy"));
    }
