...
public class Menu_InGame_AddCiv_ChangeGovernment
extends Menu {
    public Menu_InGame_AddCiv_ChangeGovernment() {
    ...
    public Menu_InGame_AddCiv_ChangeGovernment(int nID) {
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_InGameAction(CFG.lang.get("Close"), -1, 2, tY += CFG.PADD, CFG.BUTTON_W, true){
            ...
            public int getWidthE() {
                return Menu_InGame_AddCiv_ChangeGovernment.this.getW();
            }

            @Override
            public void actionElem(int iID) {
                Menu_InGame_AddCiv_ChangeGovernment.this.setVisibleM(false);
            }
        });
        ...
        for (int i = 0; i < CFG.ideologiesMgr.getIdeologiesSize(); ++i) {
            ...
            menuElements.add(new Button_Diplomacy_ChangeGovernment2_NewGame(i, 2, tY, CFG.BUTTON_W * 2, true){
                ...
                @Override
                public void actionElem(int iID) {
                    if (Menu_InGame_AddCiv.civTag != null && !Menu_InGame_AddCiv.civTag.isEmpty()) {
                        Menu_InGame_AddCiv.setCivTag(CFG.ideologiesMgr.getRealTag(Menu_InGame_AddCiv.civTag) + CFG.ideologiesMgr.getIdeologyID(this.getCurr()).getExtraTag());
                    }
