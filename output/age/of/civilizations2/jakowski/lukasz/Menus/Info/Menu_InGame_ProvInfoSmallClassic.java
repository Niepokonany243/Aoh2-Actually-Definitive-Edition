...
import age.of.civilizations2.jakowski.lukasz.Button.Stats.Button_Stats_Image_Population;
...
public class Menu_InGame_ProvInfoSmallClassic
extends Menu {
    public static int iMaxWidth = 1;
    private Menu_InGame_ProvInfoSmall.Box box;
    ...
    public Menu_InGame_ProvInfoSmallClassic() {
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        this.box = new Menu_InGame_ProvInfoSmall.Box();
        ...
        menuElements.add(new Button_GameNextTurn(null, -1, CFG.GAMEWIDTH - tempWidth - CFG.PADD - CFG.map.getMpB().getMinimapWidth(), CFG.PADD, tempWidth, true){
            ...
            public void setTextE(String sText) {
                ...
                Menu_InGame_ProvInfoSmallClassic.this.updateTurnWidth();
            }
        });
        menuElements.add(new Text("", CFG.PADD, CFG.GAMEWIDTH - CFG.map.getMpB().getMinimapWidth() * 2 - CFG.PADD * 3 - tempWidth, CFG.BUTTON_H + CFG.PADD * 2 - (CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2), CFG.PADD * 2, CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2, CFG.FONT_BOLD_SMALL){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_ProvInfoSmallClassic.this.getMenuElem(0).getPosXE() - CFG.PADD * 2 - CFG.iProvinceNameWidth;
            }
        ...
        menuElements.add(new Button_Stats_Image_Population("", 0.85f, CFG.PADD, ((MenuElemUI)menuElements.get(2)).getPosY() + ((MenuElemUI)menuElements.get(2)).getHeightE() + CFG.PADD, 1, tierHeight, true, true){
        ...
        menuElements.add(new Button_Transparent_WithHoverEnabled(CFG.GAMEWIDTH - CFG.map.getMpB().getMinimapWidth() * 2, 0, CFG.terrainTypesManager.getIcon(0).getWidth() + CFG.PADD * 2, CFG.terrainTypesManager.getIcon(0).getHeight() + CFG.PADD * 2, true){

            @Override
            public int getPosXE() {
                return Menu_InGame_ProvInfoSmallClassic.this.getMenuElem(0).getPosXE() - CFG.PADD * 2 - this.getWidthE();
            }
        ...
        menuElements.add(new Button_Stats_Image(Images.economy, "", 0.85f, CFG.PADD, ((MenuElemUI)menuElements.get(4)).getPosY() + ((MenuElemUI)menuElements.get(4)).getHeightE() + CFG.PADD, 1, tierHeight, true, true){
        ...
        menuElements.add(new Button_Stats_Image(Images.popGrowth, "", 1.0f, CFG.PADD, ((MenuElemUI)menuElements.get(4)).getPosY(), 1, tierHeight, true, true){
            int iCurrent;
            {
                this.iCurrent = 0;
            }
        ...
        menuElements.add(new Button_Stats_Image(Images.development, "", 1.0f, CFG.PADD, ((MenuElemUI)menuElements.get(7)).getPosY(), 1, tierHeight, true, true){
            int iCurrent;
            {
                this.iCurrent = 0;
            }
        ...
        menuElements.add(new Button_Stats_Image(Images.diploStability, "", 1.0f, CFG.PADD, ((MenuElemUI)menuElements.get(7)).getPosY(), 1, tierHeight, true, true){
            int iCurrent;
            {
                this.iCurrent = 0;
            }
        ...
        menuElements.add(new Text("", CFG.PADD, CFG.GAMEWIDTH - CFG.map.getMpB().getMinimapWidth() * 2 - CFG.PADD * 3 - tempWidth, CFG.BUTTON_H + CFG.PADD * 2 - (CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2), CFG.PADD * 2, CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_ProvInfoSmallClassic.this.getMenuElem(0).getPosXE() - CFG.PADD - CFG.iProvinceNameWidth - this.getWidthE();
            }
        ...
        menuElements.add(new Button_Stats_Image(Images.diploRevolution, "", 1.0f, CFG.PADD, ((MenuElemUI)menuElements.get(7)).getPosY(), 1, tierHeight, true, true){
            int iCurrent;
            {
                this.iCurrent = 0;
            }
        ...
        menuElements.add(new Text("0", 0, CFG.GAMEWIDTH, CFG.BUTTON_H + CFG.PADD * 2 - (CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2), CFG.PADD * 2, CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2, CFG.FONT_BOLD_SMALL){

            @Override
            public int getPosXE() {
                return Menu_InGame_ProvInfoSmallClassic.this.getMenuElem(0).getPosXE() - CFG.PADD - this.getWidthE();
            }
            ...
            @Override
            public void drawE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
                Renderer.drawText(oSB, this.fontID, this.getTextE(), this.getPosXE() + CFG.PADD + iTranslateX, this.getPosY() + (int)((float)this.getHeightE() / 2.0f - (float)this.getTextHeight() / 2.0f) + iTranslateY, this.getColor(isActive));
            }
    ...
    public static final void updateBuildingsList(int nProvinceID) {
        ...
        iBuildingsWidth = 0;
        for (int i = 0; i < lBuildingsImages.size(); ++i) {
            iBuildingsWidth += (int)((float)IMGManager.getIMG(lBuildingsImages.get(i)).getWidth() * Menu_InGame_ProvInfoSmallClassic.getImageScale(lBuildingsImages.get(i))) + CFG.PADD;
        }
    ...
    public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
        ...
        if (iMaxWidth != 0) {
            if (iMaxWidth > 0) {
                IMGManager.getIMG(Images.bgGameMenu).draw2(oSB, this.getPosX() + 1 + iTranslateX, this.getPosY() + iTranslateY, iMaxWidth, this.getHeightM());
                ...
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.bgGameMenuRSmall).draw2(oSB, this.getPosX() + 1 + iMaxWidth + iTranslateX, this.getPosY() - 1 + iTranslateY, IMGManager.getIMG(Images.bgGameMenuRSmall).getWidth(), this.getHeightM() + 1, true, false);
        ...
        if (CFG.core.getActiveProvID() >= 0) {
            IMGManager.getIMG(Images.botIconsBG).draw2(oSB, CFG.GAMEWIDTH - CFG.PADD * 2 - this.getMenuElem(0).getWidthE() - CFG.PADD * 2 - CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).getWidth() + iTranslateX, this.getPosY() + iTranslateY, CFG.PADD * 2 + CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).getWidth(), this.getHeightM());
            ...
            if (CFG.FOG_OF_WAR != 2 || CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(activeProvinceInfo)) {
                CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).draw(oSB, CFG.GAMEWIDTH - CFG.PADD * 2 - this.getMenuElem(0).getWidthE() - CFG.PADD - CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).getWidth() + iTranslateX, this.getPosY() + CFG.PADD + iTranslateY);
            } else {
                IMGManager.getIMG(Images.randomCivilizationFlag).draw(oSB, CFG.GAMEWIDTH - CFG.PADD * 2 - this.getMenuElem(0).getWidthE() - CFG.PADD - CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).getWidth() + iTranslateX, this.getPosY() + CFG.PADD + iTranslateY, CFG.CIV_FLAG_WIDTH, CFG.CIV_FLAG_HEIGHT);
                IMGManager.getIMG(Images.flagRectSmall).draw(oSB, CFG.GAMEWIDTH - CFG.PADD * 2 - this.getMenuElem(0).getWidthE() - CFG.PADD - CFG.terrainTypesManager.getIcon(CFG.core.getProv(activeProvinceInfo).getTerrainTypeID()).getWidth() + iTranslateX, this.getPosY() + CFG.PADD + iTranslateY);
            }
