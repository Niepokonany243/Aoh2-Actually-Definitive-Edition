...
public class Menu_MapEditor_PortPosition_Convert
extends Menu {
    ...
    public final void actionEL(int iID) {
        ...
        if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2 != CFG.map.getMapScale(CFG.map.getActiveMapIDN())) {
            CFG.setDialogType(DialogType.CONVERT_PORT_POSITION_TO_ANOTHER_SCALE);
        }
    }
