...
public class Menu_InGame_Message_DeclarationOfIndependence_ByVassal
extends Menu {
    ...
    public Menu_InGame_Message_DeclarationOfIndependence_ByVassal() {
        ...
        this.initMenu(new TitleM(CFG.lang.get("DeclarationOfIndependence"), CFG.BUTTON_H * 3 / 5, true, true), CFG.CIV_INFO_MENU_WIDTH + CFG.PADD * 2, tempMenuPosY, tempWidth, ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getPosY() + ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD + tempMenuPosY > CFG.GAMEHEIGHT - CFG.BUTTON_H - CFG.PADD * 2 ? Math.max(CFG.GAMEHEIGHT - CFG.BUTTON_H - CFG.PADD * 2 - tempMenuPosY, (CFG.TEXT_HEIGHT_DEFAULT + CFG.PADD * 2) * 6) : ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getPosY() + ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, menuElements, false, true);
        this.updateLang();
    }

    public Menu_InGame_Message_DeclarationOfIndependence_ByVassal(int onCivID, int iMessageID, int iValue) {
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        ...
        menuElements.add(new ButtonN_Civs(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId(), onCivID, 2, tY, tempWidth - 4){
            ...
            public int getWidthE() {
                return Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getElementW() * 2;
            }
        });
        ...
        tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE();
        menuElements.add(new Button_InGameAction(CFG.lang.get("Fine") + "!", -1, 2 + CFG.PADD, tY += CFG.PADD, CFG.BUTTON_W, true){

            @Override
            public int getWidthE() {
                return Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getElementW() - CFG.PADD - CFG.PADD / 2;
            }
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("WeWillSignATruceUntilX", GameCalendar.getDate_ByTurnID(GameCalendar.TURNID + GameValues.gvUltimatum.ULTIMATUM_TRUCE_TURNS))));
                nData.add(new ME_Hover_2Type_Text_Big(" [" + CFG.lang.get("TurnsX", GameValues.gvUltimatum.ULTIMATUM_TRUCE_TURNS) + "]", CFG.COLOR_NEUTRAL));
                ...
                nData.add(new ME_Hover_2Type_Flag_Big(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID, 0, 0));
        ...
        menuElements.add(new Button_InGameAction(CFG.lang.get("DeclareWar"), -1, 2, tY, CFG.BUTTON_W, true){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getElementW() + CFG.PADD / 2;
            }
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Flag_Big(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID, 0, CFG.PADD));
                nData.add(new ME_Hover_2Type_Text_Big(CFG.core.getCiv(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID).getCivName()));
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("DeclarationOfIndependence"), CFG.BUTTON_H * 3 / 4, true, true){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                IMGManager.getIMG(Images.diploMessage).drawO(oSB, Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosX() + CFG.PADD * 2 + iTranslateX, Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.diploMessage).getHeight() / 2);
