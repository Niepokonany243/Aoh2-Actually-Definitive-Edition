...
public class Menu_Workshop_Title
extends Menu {
    public Menu_Workshop_Title() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("SubmitYourModsToTheSteamWorkshop") + " - Age of History 2: Definitive Edition");
    }
