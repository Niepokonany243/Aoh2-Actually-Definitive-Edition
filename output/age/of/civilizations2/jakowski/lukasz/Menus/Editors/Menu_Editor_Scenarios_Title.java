...
public class Menu_Editor_Scenarios_Title
extends Menu {
    public Menu_Editor_Scenarios_Title() {
    ...
    public void updateLang() {
        ...
        this.getTitleM().setText(CFG.lang.get("ScenarioEditor") + " - Age of History 2: Definitive Edition");
    }
