...
public class Menu_CreateScenario_Cores_AddCiv_Alphabet
extends Menu {
    private List<Character> lCharacters;
    private String nSearch = null;

    public Menu_CreateScenario_Cores_AddCiv_Alphabet() {
        int a;
        boolean addChar;
        int i;
        ...
        menuElements.add(new Button_Classic_Classic_Search("", CFG.PADD * 2, 0, CFG.PADD, CFG.BUTTON_W * 2, CFG.BUTTON_H, true){
            ...
            public String getTextToDrawElem() {
                return Menu_CreateScenario_Cores_AddCiv_Alphabet.this.nSearch + ": " + super.getTextToDrawElem();
            }
        });
