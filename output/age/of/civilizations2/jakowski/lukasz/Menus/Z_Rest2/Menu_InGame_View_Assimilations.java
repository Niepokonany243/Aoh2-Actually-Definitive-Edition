...
public class Menu_InGame_View_Assimilations
extends Menu {
    public static long lTime = 0L;
    public static boolean hideAnimation = true;

    public Menu_InGame_View_Assimilations() {
        int i;
        ...
        for (i = 1; i < CFG.core.getCivsSize(); ++i) {
            if (CFG.core.getCiv(i).getNumOfProvs() <= 0 || CFG.core.getCiv((int)i).civGD.aACSG <= 0L) continue;
            tempCivs.add(i);
        }
        while (!tempCivs.isEmpty()) {
            int tBest = 0;
            for (int i2 = 1; i2 < tempCivs.size(); ++i2) {
                if (CFG.core.getCiv((int)((Integer)tempCivs.get((int)i2)).intValue()).civGD.aACSG <= CFG.core.getCiv((int)((Integer)tempCivs.get((int)tBest)).intValue()).civGD.aACSG) continue;
                tBest = i2;
            }
                    ...
                    public void buildElemHover() {
                        try {
                            ...
                            if (this.iCivID > 0) {
                                ...
                                nData.add(new ME_Hover_2Type_Text("" + (int)(CFG.core.getCiv(this.iCivID).getStabilityCiv() * 100.0f) + "%", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                                nData.add(new ME_Hover_2Type_Image(Images.diploStability, CFG.PADD, 0));
                                nElements.add(new MEHover_2E(nData));
                                nData.clear();
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("TotalAssimilationCost") + (playerPos > 0 ? " #" + playerPos : ""), CFG.BUTTON_H * 3 / 5, false, false){

            @Override
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                IMGManager.getIMG(Images.gameTopEdgeTitle).draw2O(oSB, Menu_InGame_View_Assimilations.this.getPosX() + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - Core.PADDING - IMGManager.getIMG(Images.gameTopEdgeTitle).getHeight() - this.getHeightT(), Menu_InGame_View_Assimilations.this.getWidthM() + 2 + Core.PADDING, this.getHeightT() + Core.PADDING, true, false);
                ...
                IMGManager.getIMG(Images.pix255).drawO(oSB, Menu_InGame_View_Assimilations.this.getPosX() + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight(), Menu_InGame_View_Assimilations.this.getWidthM());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_Assimilations.this.getPosX() + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight(), Menu_InGame_View_Assimilations.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, Menu_InGame_View_Assimilations.this.getPosX() + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.line32Off1).getHeight() - 1, Menu_InGame_View_Assimilations.this.getWidthM(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_Assimilations.this.getPosX() + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_Assimilations.this.getWidthM() / 4, 1);
                IMGManager.getIMG(Images.sliderGradient).drawO(oSB, Menu_InGame_View_Assimilations.this.getPosX() + Menu_InGame_View_Assimilations.this.getWidthM() - Menu_InGame_View_Assimilations.this.getWidthM() / 4 + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - IMGManager.getIMG(Images.pix255).getHeight() - IMGManager.getIMG(Images.sliderGradient).getHeight(), Menu_InGame_View_Assimilations.this.getWidthM() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                IMGManager.getIMG(Images.diploStability).drawO(oSB, nPosX + CFG.PADD * 2 + iTranslateX, Menu_InGame_View_Assimilations.this.getPosY() - this.getHeightT() / 2 - IMGManager.getIMG(Images.diploStability).getHeight() / 2);
