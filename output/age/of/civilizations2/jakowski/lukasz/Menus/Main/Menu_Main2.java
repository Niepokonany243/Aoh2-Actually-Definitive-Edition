...
extends Menu {
    ...
    public Menu_Main2() {
        ...
        menuElements.add(new Button_Classic_LRMain_TextScale(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, true){
            ...
            public void buildElemHover() {
                try {
                    ArrayList<MEHover_2E> nElements = new ArrayList<MEHover_2E>();
                    ArrayList<ME_Hover_2Type> nData = new ArrayList<ME_Hover_2Type>();
                    nData.add(new ME_Hover_2Type_Text(CFG.lang.get("RandomGame"), CFG.COLOR_HOVER_TITLE));
        ...
        menuElements.add(new Button_Classic_LRMain_TextScale_Important(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, true){});
        menuElements.add(new Button_Classic_LRMain_TextScale(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, true));
        menuElements.add(new Button_Classic_LRMain_TextScale(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, false));
        menuElements.add(new Button_Classic_LRMain_TextScale(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, false));
        menuElements.add(new Button_Classic_LRMain_TextScale(null, -1, 0, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempMenuWidth, CFG.BUTTON_H, false));
        tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD;
        this.initMenu(null, Menu_GamesTitle.getMenuPosX_Default(), 0, tempMenuWidth, CFG.GAMEHEIGHT - CFG.BUTTON_H - CFG.PADD, menuElements);
        this.updateLang();
    ...
    public void updateLang() {
        ...
        this.getMenuElem(5).setTextE(CFG.lang.get("AgeofCivilizations"));
        this.getMenuElem(6).setTextE(CFG.lang.get("Tutorial"));
        this.getMenuElem(7).setTextE(CFG.lang.get("Achievements"));
        this.getMenuElem(8).setTextE(CFG.lang.get("HallofFame"));
        this.getMenuElem(9).setTextE(CFG.lang.get("Leaderboards"));
        this.getMenuElem(10).setTextE(CFG.lang.get("Statistics"));
    }
    ...
    public static final void clickRandomGame() {
        ...
        CFG.PLUNDER_CHANCE = 0.0f;
        CFG.GENOCIDE_CHANCE = 0.0f;
        CFG.AI_GENOCIDE_ENABLED = true;
        CFG.REBELS_GENOCIDE_ENABLED = false;
