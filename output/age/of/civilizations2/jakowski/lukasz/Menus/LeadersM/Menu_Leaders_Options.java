...
public class Menu_Leaders_Options
extends Menu {
    ...
    public void updateLang() {
        this.getMenuElem(0).setTextE(CFG.lang.get("AddNewLeader"));
    }
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            case 0: {
                ...
                CFG.leaderGameData = new Leader_GameData();
                CFG.leaderGameData.getLeaderOfCiv().setTag(System.currentTimeMillis() + CFG.extraRandomTag());
                ...
                GameCalendar.currYear = CFG.leaderGameData.getLeaderOfCiv().getYear();
                CFG.CREATE_SCENARIO_AGE = CFG.gameAges.getAgeOfYear(GameCalendar.currYear);
