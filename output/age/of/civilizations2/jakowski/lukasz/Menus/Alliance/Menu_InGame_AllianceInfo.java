...
public class Menu_InGame_AllianceInfo
extends Menu {
    ...
    public Menu_InGame_AllianceInfo() {
    ...
    public Menu_InGame_AllianceInfo(int nCivA, int nCivB) {
        ArrayList<MenuElemUI> menuElements = new ArrayList<MenuElemUI>();
        menuElements.add(new Button_Transparent(0, 0, 1, 1, false));
        this.initMenu(null, 0, 0, CFG.GAMEWIDTH, CFG.GAMEHEIGHT, menuElements);
        this.sWar = CFG.lang.get("Alliance") + "!";
        ...
        CFG.glyphLay.setText(CFG.fontMain.get(0), CFG.core.getCiv(this.iAggressorID).getCivName());
        this.iAggressorWidth = (int)(CFG.glyphLay.width * 0.8f);
        CFG.glyphLay.setText(CFG.fontMain.get(0), CFG.core.getCiv(this.iDefenderID).getCivName());
        this.iDefenderWidth = (int)(CFG.glyphLay.width * 0.8f);
    ...
    private final int getWidth2() {
        return (int)((float)Math.max(this.iWarWidth + CFG.PADD * 2, (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) + CFG.PADD * 2 + 4 + CFG.PADD * 2 + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) * 2 + CFG.PADD * 2 + Math.max(this.iAggressorWidth, this.iDefenderWidth) * 2 + CFG.PADD * 2) * 1.3f);
    }
    ...
    public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
        ...
        IMGManager.getIMG(Images.diploAlliance).drawO(oSB, this.getPosX2() + this.getWidth2() / 2 - (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) / 2 + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + CFG.TEXT_HEIGHT_DEFAULT / 2 - (int)((float)IMGManager.getIMG(Images.diploAlliance).getHeight() * this.getImageScale(Images.diploAlliance)) / 2 - IMGManager.getIMG(Images.diploAlliance).getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)), (int)((float)IMGManager.getIMG(Images.diploAlliance).getHeight() * this.getImageScale(Images.diploAlliance)));
        try {
        ...
        IMGManager.getIMG(Images.pix255).drawO(oSB, this.getPosX2() + this.getWidth2() / 2 + (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) / 2 + CFG.PADD + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + CFG.TEXT_HEIGHT_DEFAULT / 2 - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)) / 2 - IMGManager.getIMG(Images.pix255).getHeight() + iTranslateY, 2, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        oSB.setColor(new Color(1.0f, 1.0f, 1.0f, tAlpha));
        CFG.core.getCiv(this.iAggressorID).getFlagC().drawO(oSB, this.getPosX2() + this.getWidth2() / 2 - (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) / 2 - CFG.PADD - 2 - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + CFG.TEXT_HEIGHT_DEFAULT / 2 - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)) / 2 - CFG.core.getCiv(this.iAggressorID).getFlagC().getHeight() + iTranslateY, (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)), (int)((float)IMGManager.getIMG(Images.flagRectSmall).getHeight() * this.getImageScale(Images.flagRectSmall)));
        ...
        CFG.drawTextDefault(oSB, this.sWar, this.getPosX2() + this.getWidth2() / 2 - this.iWarWidth / 2 + iTranslateX, this.getPosY2() + CFG.PADD * 2 + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.9f) / 2.0f) + iTranslateY, new Color(CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_ALLIANCE.getR(), CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_ALLIANCE.getG(), CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_ALLIANCE.getB(), 1.0f * tAlpha));
        CFG.fontMain.get(0).getData().setScale(0.8f);
        CFG.drawTextDefault(oSB, CFG.core.getCiv(this.iAggressorID).getCivName(), this.getPosX2() + this.getWidth2() / 2 - (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) / 2 - CFG.PADD - 2 - (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) - CFG.PADD - this.iAggressorWidth + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.8f) / 2.0f) + iTranslateY, new Color(CFG.COLOR_NEUTRAL.r, CFG.COLOR_NEUTRAL.g, CFG.COLOR_NEUTRAL.b, CFG.COLOR_TEXT_NUM_OF_PROVINCES.a * tAlpha));
        CFG.drawTextDefault(oSB, CFG.core.getCiv(this.iDefenderID).getCivName(), this.getPosX2() + this.getWidth2() / 2 + (int)((float)IMGManager.getIMG(Images.flagRectSmall).getWidth() * this.getImageScale(Images.flagRectSmall)) + (int)((float)IMGManager.getIMG(Images.diploAlliance).getWidth() * this.getImageScale(Images.diploAlliance)) / 2 + CFG.PADD + 2 + CFG.PADD + iTranslateX, this.getPosY2() + this.getHeight2() / 2 + CFG.PADD + (int)(((float)CFG.TEXT_HEIGHT_DEFAULT - (float)CFG.TEXT_HEIGHT_DEFAULT * 0.8f) / 2.0f) + iTranslateY, new Color(CFG.COLOR_NEUTRAL.r, CFG.COLOR_NEUTRAL.g, CFG.COLOR_NEUTRAL.b, CFG.COLOR_TEXT_NUM_OF_PROVINCES.a * tAlpha));
