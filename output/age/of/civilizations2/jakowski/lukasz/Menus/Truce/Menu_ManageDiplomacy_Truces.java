...
public class Menu_ManageDiplomacy_Truces
extends Menu {
    public Menu_ManageDiplomacy_Truces() {
    ...
    public final void actionEL(int iID) {
        switch (iID) {
            case 2: {
                CFG.core.setCivTruce(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2, 5);
