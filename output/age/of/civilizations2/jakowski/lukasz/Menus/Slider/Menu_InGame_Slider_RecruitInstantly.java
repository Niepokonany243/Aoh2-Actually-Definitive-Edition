...
public class Menu_InGame_Slider_RecruitInstantly
extends Menu {
    ...
    public void extraAction() {
        ...
        CFG.gameAction.recruitArmyInstantly(CFG.core.getActiveProvID(), this.getMenuElem(2).getCurr(), CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId());
        CFG.core.checkProvinceActionMenu();
        CFG.core.autoBuildChooseProvinceMode(true);
