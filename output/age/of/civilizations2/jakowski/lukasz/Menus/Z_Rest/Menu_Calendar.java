...
public class Menu_Calendar
extends Menu {
    public Menu_Calendar() {
        ...
        menuElements.add(new Button_ArrowLeft(0, CFG.PADD, CFG.BUTTON_H, CFG.BUTTON_H * 2 / 3){
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text(GameCalendar.getMonthName(GameCalendar.currMonth - 1), CFG.COLOR_HOVER_TITLE));
        ...
        menuElements.add(new Text(GameCalendar.getMonthName(GameCalendar.currMonth), -1, CFG.BUTTON_H, CFG.PADD, tempW - CFG.BUTTON_H * 2, CFG.BUTTON_H * 2 / 3){
        ...
        for (int i = 0; i < GameCalendar.getNumOfDaysInMonth(GameCalendar.currMonth); ++i) {
    ...
    public void actionEL(int iID) {
        if (iID != this.getMenuElemsSize() - 1) {
            if (iID == 0) {
                GameCalendar.minusMonth();
                CFG.menus.rebuildScenario_Age_Calendar();
                CFG.menus.updateScenario_Age_Date();
                ...
                CFG.toastM.addM(GameCalendar.getCurrDate());
                ArrayList<String> tMess = new ArrayList<String>();
                ArrayList<Color> tColor = new ArrayList<Color>();
                tMess.add(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getName());
                tColor.add(Color.WHITE);
