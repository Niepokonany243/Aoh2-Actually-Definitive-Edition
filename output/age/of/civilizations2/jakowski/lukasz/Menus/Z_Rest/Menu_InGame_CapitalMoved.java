...
extends Menu {
    ...
    public Menu_InGame_CapitalMoved(int nProvinceID, int nCivID) {
        ...
        this.initMenu(null, 0, 0, CFG.GAMEWIDTH, CFG.GAMEHEIGHT, menuElements);
        this.iCivA = nCivID;
        this.sWar = CFG.core.getProv(nProvinceID).getCitSize() > 0 ? CFG.lang.get("CapitalMoved") + ": " + CFG.core.getProv(nProvinceID).getCit(0).getCityName() : CFG.lang.get("CapitalMoved");
