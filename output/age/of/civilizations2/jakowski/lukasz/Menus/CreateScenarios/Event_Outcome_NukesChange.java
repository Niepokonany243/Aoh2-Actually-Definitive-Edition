...
public class Event_Outcome_NukesChange
extends Event_Outcome {
    ...
    public void outcomeAction() {
        if (this.canMakeAction()) {
            CFG.core.getCiv((int)this.getCivID()).civGD.iNukes = Math.max(0, (int)(CFG.core.getCiv((int)this.getCivID()).civGD.iNukes + this.getValue()));
    ...
    public String getConditionText() {
        try {
            return CFG.lang.get("AtomicBombs") + ": " + CFG.core.getCiv(this.getCivID()).getCivName() + ", " + (this.getValue() > 0 ? "+" : "") + this.getValue();
        }
        catch (IndexOutOfBoundsException ex) {
            return CFG.lang.get("AtomicBombs");
        }
    }
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(CFG.lang.get("AtomicBombs") + ": ", CFG.COLOR_HOVER_TITLE));
