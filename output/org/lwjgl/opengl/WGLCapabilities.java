...
public final class WGLCapabilities {
    ...
    WGLCapabilities(FunctionProvider provider, Set<String> ext) {
        ...
        this.WGL_AMD_gpu_association = ext.contains("WGL_AMD_gpu_association") && WGLCapabilities.checkExtension("WGL_AMD_gpu_association", WGLAMDGPUAssociation.isAvailable(this));
        this.WGL_ARB_buffer_region = ext.contains("WGL_ARB_buffer_region") && WGLCapabilities.checkExtension("WGL_ARB_buffer_region", WGLARBBufferRegion.isAvailable(this));
        this.WGL_ARB_context_flush_control = ext.contains("WGL_ARB_context_flush_control");
        this.WGL_ARB_create_context = ext.contains("WGL_ARB_create_context") && WGLCapabilities.checkExtension("WGL_ARB_create_context", WGLARBCreateContext.isAvailable(this));
        ...
        this.WGL_ARB_extensions_string = ext.contains("WGL_ARB_extensions_string") && WGLCapabilities.checkExtension("WGL_ARB_extensions_string", WGLARBExtensionsString.isAvailable(this));
        this.WGL_ARB_framebuffer_sRGB = ext.contains("WGL_ARB_framebuffer_sRGB");
        this.WGL_ARB_make_current_read = ext.contains("WGL_ARB_make_current_read") && WGLCapabilities.checkExtension("WGL_ARB_make_current_read", WGLARBMakeCurrentRead.isAvailable(this));
        this.WGL_ARB_multisample = ext.contains("WGL_ARB_multisample");
        this.WGL_ARB_pbuffer = ext.contains("WGL_ARB_pbuffer") && WGLCapabilities.checkExtension("WGL_ARB_pbuffer", WGLARBPbuffer.isAvailable(this));
        this.WGL_ARB_pixel_format = ext.contains("WGL_ARB_pixel_format") && WGLCapabilities.checkExtension("WGL_ARB_pixel_format", WGLARBPixelFormat.isAvailable(this));
        this.WGL_ARB_pixel_format_float = ext.contains("WGL_ARB_pixel_format_float");
        this.WGL_ARB_render_texture = ext.contains("WGL_ARB_render_texture") && WGLCapabilities.checkExtension("WGL_ARB_render_texture", WGLARBRenderTexture.isAvailable(this));
        ...
        this.WGL_EXT_extensions_string = ext.contains("WGL_EXT_extensions_string") && WGLCapabilities.checkExtension("WGL_EXT_extensions_string", WGLEXTExtensionsString.isAvailable(this));
        ...
        this.WGL_EXT_swap_control = ext.contains("WGL_EXT_swap_control") && WGLCapabilities.checkExtension("WGL_EXT_swap_control", WGLEXTSwapControl.isAvailable(this));
        this.WGL_EXT_swap_control_tear = ext.contains("WGL_EXT_swap_control_tear");
        this.WGL_NV_copy_image = ext.contains("WGL_NV_copy_image") && WGLCapabilities.checkExtension("WGL_NV_copy_image", WGLNVCopyImage.isAvailable(this));
        this.WGL_NV_delay_before_swap = ext.contains("WGL_NV_delay_before_swap") && WGLCapabilities.checkExtension("WGL_NV_delay_before_swap", WGLNVDelayBeforeSwap.isAvailable(this));
        this.WGL_NV_DX_interop = ext.contains("WGL_NV_DX_interop") && WGLCapabilities.checkExtension("WGL_NV_DX_interop", WGLNVDXInterop.isAvailable(this));
        this.WGL_NV_DX_interop2 = ext.contains("WGL_NV_DX_interop2");
        this.WGL_NV_float_buffer = ext.contains("WGL_NV_float_buffer");
        this.WGL_NV_gpu_affinity = ext.contains("WGL_NV_gpu_affinity") && WGLCapabilities.checkExtension("WGL_NV_gpu_affinity", WGLNVGPUAffinity.isAvailable(this));
        ...
        this.WGL_NV_swap_group = ext.contains("WGL_NV_swap_group") && WGLCapabilities.checkExtension("WGL_NV_swap_group", WGLNVSwapGroup.isAvailable(this));
        this.WGL_NV_vertex_array_range = ext.contains("WGL_NV_vertex_array_range") && WGLCapabilities.checkExtension("WGL_NV_vertex_array_range", WGLNVVertexArrayRange.isAvailable(this));
    }
