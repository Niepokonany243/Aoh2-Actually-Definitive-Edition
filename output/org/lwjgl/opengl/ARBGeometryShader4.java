...
public class ARBGeometryShader4 {
    ...
    static boolean isAvailable(GLCapabilities caps) {
        return Checks.checkFunctions(caps.glProgramParameteriARB, caps.glFramebufferTextureARB, caps.glFramebufferTextureLayerARB, caps.glFramebufferTextureFaceARB);
    }
