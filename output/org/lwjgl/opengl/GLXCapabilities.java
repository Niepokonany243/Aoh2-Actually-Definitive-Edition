...
public final class GLXCapabilities {
    ...
    GLXCapabilities(FunctionProvider provider, Set<String> ext) {
        ...
        this.GLX11 = ext.contains("GLX11") && GLXCapabilities.checkExtension("GLX11", org.lwjgl.opengl.GLX11.isAvailable(this));
        this.GLX12 = ext.contains("GLX12") && GLXCapabilities.checkExtension("GLX12", org.lwjgl.opengl.GLX12.isAvailable(this));
        this.GLX13 = ext.contains("GLX13") && GLXCapabilities.checkExtension("GLX13", org.lwjgl.opengl.GLX13.isAvailable(this));
        this.GLX14 = ext.contains("GLX14") && GLXCapabilities.checkExtension("GLX14", org.lwjgl.opengl.GLX14.isAvailable(this));
        this.GLX_AMD_gpu_association = ext.contains("GLX_AMD_gpu_association") && GLXCapabilities.checkExtension("GLX_AMD_gpu_association", GLXAMDGPUAssociation.isAvailable(this));
        this.GLX_ARB_context_flush_control = ext.contains("GLX_ARB_context_flush_control");
        this.GLX_ARB_create_context = ext.contains("GLX_ARB_create_context") && GLXCapabilities.checkExtension("GLX_ARB_create_context", GLXARBCreateContext.isAvailable(this));
        ...
        this.GLX_ARB_get_proc_address = ext.contains("GLX_ARB_get_proc_address") && GLXCapabilities.checkExtension("GLX_ARB_get_proc_address", GLXARBGetProcAddress.isAvailable(this));
        ...
        this.GLX_EXT_import_context = ext.contains("GLX_EXT_import_context") && GLXCapabilities.checkExtension("GLX_EXT_import_context", GLXEXTImportContext.isAvailable(this));
        ...
        this.GLX_EXT_swap_control = ext.contains("GLX_EXT_swap_control") && GLXCapabilities.checkExtension("GLX_EXT_swap_control", GLXEXTSwapControl.isAvailable(this));
        this.GLX_EXT_swap_control_tear = ext.contains("GLX_EXT_swap_control_tear");
        this.GLX_EXT_texture_from_pixmap = ext.contains("GLX_EXT_texture_from_pixmap") && GLXCapabilities.checkExtension("GLX_EXT_texture_from_pixmap", GLXEXTTextureFromPixmap.isAvailable(this));
        ...
        this.GLX_NV_copy_buffer = ext.contains("GLX_NV_copy_buffer") && GLXCapabilities.checkExtension("GLX_NV_copy_buffer", GLXNVCopyBuffer.isAvailable(this));
        this.GLX_NV_copy_image = ext.contains("GLX_NV_copy_image") && GLXCapabilities.checkExtension("GLX_NV_copy_image", GLXNVCopyImage.isAvailable(this));
        this.GLX_NV_delay_before_swap = ext.contains("GLX_NV_delay_before_swap") && GLXCapabilities.checkExtension("GLX_NV_delay_before_swap", GLXNVDelayBeforeSwap.isAvailable(this));
        ...
        this.GLX_NV_swap_group = ext.contains("GLX_NV_swap_group") && GLXCapabilities.checkExtension("GLX_NV_swap_group", GLXNVSwapGroup.isAvailable(this));
        this.GLX_SGI_make_current_read = ext.contains("GLX_SGI_make_current_read") && GLXCapabilities.checkExtension("GLX_SGI_make_current_read", GLXSGIMakeCurrentRead.isAvailable(this));
        this.GLX_SGI_swap_control = ext.contains("GLX_SGI_swap_control") && GLXCapabilities.checkExtension("GLX_SGI_swap_control", GLXSGISwapControl.isAvailable(this));
        this.GLX_SGI_video_sync = ext.contains("GLX_SGI_video_sync") && GLXCapabilities.checkExtension("GLX_SGI_video_sync", GLXSGIVideoSync.isAvailable(this));
        this.GLX_SGIX_fbconfig = ext.contains("GLX_SGIX_fbconfig") && GLXCapabilities.checkExtension("GLX_SGIX_fbconfig", GLXSGIXFBConfig.isAvailable(this));
        this.GLX_SGIX_pbuffer = ext.contains("GLX_SGIX_pbuffer") && GLXCapabilities.checkExtension("GLX_SGIX_pbuffer", GLXSGIXPbuffer.isAvailable(this));
        this.GLX_SGIX_swap_barrier = ext.contains("GLX_SGIX_swap_barrier") && GLXCapabilities.checkExtension("GLX_SGIX_swap_barrier", GLXSGIXSwapBarrier.isAvailable(this));
        this.GLX_SGIX_swap_group = ext.contains("GLX_SGIX_swap_group") && GLXCapabilities.checkExtension("GLX_SGIX_swap_group", GLXSGIXSwapGroup.isAvailable(this));
    }
